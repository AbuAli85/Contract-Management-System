 ...
 */
export const promoterFormSchema = z
  .object({
    // Basic Information
    name_en: z
      .string()
    ...
    status: z
      .enum(['active', 'inactive', 'pending', 'suspended', 'on_leave'])
      .default('pending'),
    overall_status: z
  ...
  .refine(
    ...
    {
      message:
        'Work permit expiry date is required when work permit number is provided',
