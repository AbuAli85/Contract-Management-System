...
export const PERMISSIONS = {
  ...
  // Shared permissions
  'notifications.view_own': ['client', 'user', 'provider', 'manager', 'admin', 'super_admin'],
  'notifications.manage_own': ['client', 'user', 'provider', 'manager', 'admin', 'super_admin'],
  'communication.send': ['provider', 'admin', 'super_admin'],
  'communication.receive': ['client', 'user', 'provider', 'manager', 'admin', 'super_admin'],
  'reports.view_own': ['provider', 'admin', 'super_admin'],
  'reports.view_all': ['admin', 'super_admin'],
  
  // General permissions
  'dashboard.view': ['client', 'user', 'provider', 'manager', 'admin', 'super_admin'],
  'profile.edit_own': ['client', 'user', 'provider', 'manager', 'admin', 'super_admin'],
} as const
 ...
 */
export function hasPermission(userRole: EnhancedUserRole, permission: PermissionKey): boolean {
 ...
 */
export function hasAnyPermission(userRole: EnhancedUserRole, permissions: PermissionKey[]): boolean {
 ...
 */
export function hasAllPermissions(userRole: EnhancedUserRole, permissions: PermissionKey[]): boolean {
 ...
 */
export function hasRoleLevel(userRole: EnhancedUserRole, requiredRole: EnhancedUserRole): boolean {
 ...
 */
export function getUserPermissions(userRole: EnhancedUserRole): PermissionKey[] {
...
export async function canAccessResource(
  ...
  try {
    ...
    switch (resourceType) {
      case 'service':
        if (action === 'read') {
          return hasPermission(role, 'services.view_all') || 
        ...
        if (action === 'write' || action === 'delete') {
          ...
          return service?.provider_id === userId || 
      ...
      case 'company':
        ...
        return userCompany?.company_id === resourceId ||
