...
export class SupabaseErrorHandler {
  ...
  static handleDatabaseError(error: any, requestId?: string, userId?: string, operation?: string): SupabaseErrorDetails {
  ...
  static handleNetworkError(error: any, requestId?: string, userId?: string, operation?: string): SupabaseErrorDetails {
    const errorCode = error?.code
  ...
  static handleClientError(error: any, requestId?: string, userId?: string, operation?: string): SupabaseErrorDetails {
