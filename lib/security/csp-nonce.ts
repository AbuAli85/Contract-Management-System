...
export function buildCSPWithNonce(
  ...
  const externalConnect: string[] = ['https://*.supabase.co', 'wss://*.supabase.co', 'https://vercel.live'];
  const externalImages: string[] = ['https://*.supabase.co'];
  
  if (allowGoogleAnalytics) {
    externalScripts.push('https://*.google-analytics.com', 'https://*.googletagmanager.com');
    externalConnect.push('https://*.google-analytics.com', 'https://*.googletagmanager.com');
    externalImages.push('https://*.google-analytics.com', 'https://*.googletagmanager.com');
  }
