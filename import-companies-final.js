...
async function importCompaniesFinal() {
  console.log('=== Importing Companies (Final Corrected) ===');
...
"Falcon Eye Trading LLC","صقر العين للتجارة ش م م","1315483","Employer","ceo","Active","missing","N/A","missing","N/A","Fahad alamri","chairman@falconeyegroup.net","+96895153930","N/A","N/A","N/A","0","active","2025-07-02",""`;
  ...
  const csvFilePath = 'companies-import-final.csv';
    ...
    .on('end', async () => {
      ...
      for (const company of companies) {
        try {
          ...
          // Map to actual database schema with correct type value
          const companyData = {
            name: company['Name (EN)'] || '',
            type: 'company', // Use the correct type value
...
importCompaniesFinal().catch(console.error); 