...
describe('Party Service', () => {
  ...
  describe('fetchPartiesWithPagination', () => {
    ...
    it('should handle search with fuzzy matching', async () => {
      const mockSearchResults = [
        { id: '1', name_en: 'Test Company', similarity_score: 0.8 },
      ];
    ...
    it('should handle database errors gracefully', async () => {
      ...
      await expect(
        fetchPartiesWithPagination({ page: 1, limit: 10 })
      ).rejects.toThrow('Error fetching parties: Database connection failed');
    });
  });
  ...
  describe('searchParties', () => {
    ...
    it('should handle search errors', async () => {
      ...
      await expect(searchParties('test')).rejects.toThrow(
        'Error searching parties: Search failed'
      );
    });
  });
  ...
  describe('fetchPartyWithContacts', () => {
    it('should fetch party with contacts', async () => {
      ...
      const mockContacts = [
        { id: '1', party_id: '1', name_en: 'John Doe', is_primary: true },
      ];
  ...
  describe('saveParty', () => {
    it('should create new party', async () => {
      ...
      const mockQuery = {
        ...
        single: vi
          .fn()
          .mockResolvedValue({ data: mockCreatedParty, error: null }),
      };
    ...
    it('should update existing party', async () => {
      ...
      const mockQuery = {
        ...
        single: vi
          .fn()
          .mockResolvedValue({ data: mockUpdatedParty, error: null }),
      };
  ...
  describe('saveContact', () => {
    it('should create new contact', async () => {
      ...
      const mockQuery = {
        ...
        single: vi
          .fn()
          .mockResolvedValue({ data: mockCreatedContact, error: null }),
      };
  ...
  describe('getPartiesWithExpiringDocuments', () => {
    it('should fetch parties with expiring documents', async () => {
      const mockParties = [
        { id: '1', name_en: 'Test Company', cr_expiry_date: '2023-12-31' },
      ];
  ...
  describe('Retry Logic', () => {
    ...
    it('should not retry on validation errors', async () => {
      ...
      await expect(
        fetchPartiesWithPagination({ page: 1, limit: 10 })
      ).rejects.toThrow('Error fetching parties: Invalid input');
