...
describe('RBAC Permission Evaluation', () => {
  ...
  describe('PermissionDecision Interface', () => {
    it('should have correct PermissionDecision structure', () => {
      ...
      const decision: PermissionDecision = {
        ...
        user_id: 'user123',
        user_roles: ['user'],
        user_permissions: [{ resource: 'user', action: 'read', scope: 'own' }],
      };
  ...
  describe('PermissionEvaluator Class', () => {
    it('should be instantiable', () => {
      ...
      expect(typeof evaluator.getUserResourceActionPermissions).toBe(
        'function'
      );
    });
    ...
    it('should handle multiple permission scenarios', () => {
      ...
      const scenarios: Array<{
        ...
        },
        {
          ...
          expectedResource: 'contract',
          expectedAction: 'write',
          expectedScope: 'organization',
        },
        {
          permission: 'booking:delete:all',
          expectedResource: 'booking',
  ...
  describe('Integration Readiness', () => {
    ...
    it('should support common permission patterns', () => {
      ...
      commonPermissions.forEach(permission => {
        ...
        // Validate action
        expect(['read', 'write', 'delete', 'assign', 'revoke']).toContain(
          parts[1]
        );
