...
describe('Promoter Validation - Enhanced Functions', () => {
  ...
  describe('validateNationality', () => {
    ...
    it('should accept nationalities with hyphens and apostrophes', () => {
      const validSpecialNationalities = [
        'Costa Rican',
        "O'Connor",
        'Van der Berg',
        'De la Cruz',
  ...
  describe('getValidationSummary', () => {
    ...
    it('should provide warnings for expiring documents', () => {
      ...
      expect(summary.warnings.some(w => w.includes('ID card expires'))).toBe(
        true
      );
      expect(summary.warnings.some(w => w.includes('Passport expires'))).toBe(
        true
      );
    });
  });
