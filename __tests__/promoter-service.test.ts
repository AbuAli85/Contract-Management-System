...
const mockSupabaseClient = {
              ...
              order: vi.fn(() => ({
                range: vi.fn(() => ({
                  or: vi.fn(() => ({
                    and: vi.fn(() => ({
                      single: vi.fn(() =>
                        Promise.resolve({ data: mockPromoter, error: null })
                      ),
                    })),
                  })),
                })),
  ...
  functions: {
    invoke: vi.fn(() =>
      Promise.resolve({ data: mockImportResult, error: null })
    ),
  },
};
...
describe('Promoter Service - Enhanced Functions', () => {
  ...
  describe('exportPromotersToCSV', () => {
    ...
    it('should handle export errors', async () => {
      ...
      await expect(exportPromotersToCSV()).rejects.toThrow(
        'Failed to export promoters to CSV'
      );
    });
  });
  ...
  describe('deletePromoters', () => {
    ...
    it('should handle delete errors', async () => {
      ...
      await expect(deletePromoters(promoterIds)).rejects.toThrow(
        'Failed to delete promoters'
      );
    });
  });
  ...
  describe('updatePromoterStatus', () => {
    it('should update promoter status successfully', async () => {
      ...
      await expect(
        updatePromoterStatus(promoterId, status)
  ...
  describe('bulkUpdatePromoterStatus', () => {
    it('should bulk update promoter statuses successfully', async () => {
      ...
      await expect(
        bulkUpdatePromoterStatus(promoterIds, status)
      ).resolves.not.toThrow();
    });
    ...
    it('should handle bulk update errors', async () => {
      ...
      await expect(
        bulkUpdatePromoterStatus(promoterIds, status)
      ).rejects.toThrow('Failed to bulk update promoter status');
    });
  });
  ...
  describe('searchPromoters', () => {
    ...
    it('should handle search errors', async () => {
      ...
      await expect(searchPromoters(searchTerm)).rejects.toThrow(
        'Failed to search promoters'
      );
    });
  });
