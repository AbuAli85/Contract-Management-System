  ...
  useEffect(() => {
    ...
    try {
      ...
      if (!supabaseUrl || !supabaseAnonKey) {
        console.error(
          '❌ AuthContextProvider: Missing Supabase environment variables'
        );
        setLoading(false);
        return;
      }
      ...
      console.log(
        '✅ AuthContextProvider: Supabase client created successfully'
      );
      ...
      const initTimeout = setTimeout(() => {
        console.log(
          '🔐 AuthContextProvider: AuthService initialization timeout, forcing sync state to true'
        );
      ...
      console.error(
        '❌ AuthContextProvider: Error creating Supabase client:',
        error
      );
      setLoading(false);
    }
