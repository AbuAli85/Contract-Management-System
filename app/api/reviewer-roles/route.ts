  ...
  try {
    ...
    if (userData?.role !== 'admin') {
      return NextResponse.json(
        { error: 'Only admins can view reviewer roles' },
        { status: 403 }
      );
    }
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (userData?.role !== 'admin') {
      return NextResponse.json(
        { error: 'Only admins can assign reviewer roles' },
        { status: 403 }
      );
    }
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (userData?.role !== 'admin') {
      return NextResponse.json(
        { error: 'Only admins can update reviewer roles' },
        { status: 403 }
      );
    }
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (userData?.role !== 'admin') {
      return NextResponse.json(
        { error: 'Only admins can delete reviewer roles' },
        { status: 403 }
      );
    }
