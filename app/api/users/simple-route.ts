...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log("🔍 API Users: Query params:", { status, role, search, limit, offset })
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      user: newUser,
      message: isSignup ? "Account created successfully. Please wait for admin approval." : "User created successfully"
    })
  } catch (error) {
