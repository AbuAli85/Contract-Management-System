...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    examples: {
      'Test booking creation': 'GET /api/bookings/webhook/test?event=booking.created',
      'Test status change': 'GET /api/bookings/webhook/test?event=booking.status_changed',
      'Custom test data': 'POST /api/bookings/webhook/test with { "event": "booking.created", "test_data": { "client_name": "Custom Name" } }'
    }
  })
}
