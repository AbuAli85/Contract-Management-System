...
import { upsertBooking, createBookingPayload, type BookingPayload } from '@/lib/booking-service'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const bookingPayload = createBookingPayload(body as Partial<BookingPayload> & Pick<BookingPayload, 'service_id' | 'provider_company_id' | 'client_id'>)
