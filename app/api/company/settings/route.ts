  ...
  try {
    ...
    if (!profile?.active_company_id) {
      return NextResponse.json({
        ...
        can_edit: false,
        message:
          'No active company selected. Please set up or select a company.',
      });
    }
          ...
          if (party) {
            ...
            if (!userRole && party.type === 'Employer') {
              ...
              if (
                ...
                party.contact_email?.toLowerCase() ===
                  employerProfile.email.toLowerCase()
              ) {
    ...
    if (!userRole) {
      ...
      return NextResponse.json({
        ...
        can_edit: false,
        message:
          'You do not have access to this company. Please contact the administrator.',
      });
    }
