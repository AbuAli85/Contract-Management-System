...
const WEBHOOK_URLS = {
  'booking.created':
    process.env.MAKE_WEBHOOK_BOOKING_CREATED ||
    'https://hook.eu2.make.com/wb6i8h78k2uxwpq2qvd73lha0hs355ka',
  'booking.status_changed':
    process.env.MAKE_WEBHOOK_BOOKING_STATUS ||
    'https://hook.eu2.make.com/wb6i8h78k2uxwpq2qvd73lha0hs355ka',
  'service.created':
    process.env.MAKE_WEBHOOK_SERVICE_CREATED ||
    'https://hook.eu2.make.com/wb6i8h78k2uxwpq2qvd73lha0hs355ka',
  'user.registered':
    process.env.MAKE_WEBHOOK_USER_REGISTERED ||
    'https://hook.eu2.make.com/wb6i8h78k2uxwpq2qvd73lha0hs355ka',
};
      ...
      try {
        ...
        if (!bookingError && bookingData) {
          enrichedPayload = {
            ...
            client_name:
              bookingData.client_name || bookingData.client?.full_name,
