    ...
    console.log('Request body:', body);
      ...
      if (!pdfRes.ok) {
        ...
        return NextResponse.json(
          { error: 'Failed to generate PDF', details: errorText, status: pdfRes.status },
          { status: 500 }
        );
      }
      ...
      const pdfUrl = pdfResult.pdf_base64 ? `data:application/pdf;base64,${pdfResult.pdf_base64}` : null;
