  ...
  try {
    ...
    const mockTasks = [
      ...
      },
      {
        ...
        description:
          'Present quarterly performance report and discuss upcoming campaigns',
        dueDate: '2024-06-22',
        priority: 'medium',
        status: 'pending',
        progress: 0,
      ...
      },
      {
        ...
        description:
          'Create and manage Instagram campaign for new product line',
        dueDate: '2024-06-28',
        priority: 'low',
        status: 'completed',
        progress: 100,
      ...
      },
      {
        ...
        description:
          'Train new team members on product features and sales techniques',
        dueDate: '2024-06-30',
        priority: 'medium',
        status: 'pending',
        progress: 0,
      ...
      },
      {
        ...
        description:
          'Manage booth at industry trade show, engage with potential clients',
        dueDate: '2024-07-05',
        priority: 'high',
        status: 'pending',
        progress: 25,
