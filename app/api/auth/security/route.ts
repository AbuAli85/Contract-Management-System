      ...
      switch (action) {
        ...
        case "recommendations":
          ...
          if (securityFactors.trustedDevices === 0) {
            recommendations.push({
              ...
              description: "Mark your primary device as trusted for convenience",
              impact: "Medium", 
              effort: "Low"
            })
          }
          ...
          recommendations.push({
            ...
            description: "Regularly check your account activity for suspicious events",
            impact: "Medium",
            effort: "Low"
          })
        ...
        case "risk_assessment":
          ...
          return NextResponse.json({
            ...
            factors: riskFactors,
            recommendations: riskScore > 0.5 ? ["Enable MFA", "Verify identity"] : []
          })
