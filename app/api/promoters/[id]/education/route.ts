...
export async function GET(
  ...
  try {
    ...
    const education = mockEducation.filter(
      edu => edu.promoter_id === promoter_id
    );
    ...
    return NextResponse.json(
      { error: 'Failed to fetch promoter education' },
      { status: 500 }
    );
  }
}
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to create promoter education' },
      { status: 500 }
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to update promoter education' },
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to delete promoter education' },
      { status: 500 }
    );
  }
}
