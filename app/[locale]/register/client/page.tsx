          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <Card className="bg-white/50 border-blue-200">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-sm">
                  Create a comprehensive company profile with all necessary business details
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/50 border-green-200">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-sm">
                  Request services from verified providers and manage your requirements
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="bg-white/50 border-purple-200">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-sm">
                  Manage contracts, track progress, and maintain vendor relationships
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-sm text-muted-foreground">
                  For assistance with registration or any questions about using the platform:
                </p>
