        ...
        <div className='space-y-6 text-center'>
          <div className='space-y-4'>
            ...
            <p className='mx-auto max-w-3xl text-xl text-muted-foreground'>
              Manage contracts, promoters, and parties with our professional and
              user-friendly interface. Everything you need for efficient
              contract management in one place.
            </p>
          </div>
        ...
        <div className='mt-20 grid gap-8 md:grid-cols-3'>
          <div className='rounded-lg bg-card p-6 text-center shadow-md transition-shadow hover:shadow-lg border border-border'>
            ...
            <p className='text-muted-foreground mb-4'>
              Advanced contract generation, editing, and tracking with beautiful
              interfaces
            </p>
            <a
          ...
          <div className='rounded-lg bg-card p-6 text-center shadow-md transition-shadow hover:shadow-lg border border-border'>
            ...
            <p className='text-muted-foreground mb-4'>
              Professional promoter management with analytics, tasks, and
