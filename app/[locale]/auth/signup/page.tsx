        ...
        <CardContent className='space-y-4'>
          <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
            <h3 className='font-semibold text-yellow-900 mb-2'>
              ⚠️ Internal Server Error Fix
            </h3>
            <p className='text-sm text-yellow-800'>
              The old signup system was causing internal server errors. We've
              created a new, working registration system with proper role
              assignment.
            </p>
          </div>
          ...
          <div className='space-y-3'>
            ...
            <Button onClick={goToTest} variant='outline' className='w-full'>
              🧪 Test System First
            </Button>

            <Button onClick={goToWorking} variant='outline' className='w-full'>
          ...
          <div className='text-xs text-gray-500 text-center border-t pt-3'>
            <p>
              <strong>New System Features:</strong>
            </p>
