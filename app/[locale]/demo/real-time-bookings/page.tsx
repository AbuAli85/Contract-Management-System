...
import {
  ...
  BookingEventMonitor,
  UserEventMonitor,
} from '@/components/booking/real-time-booking-events';
import {
  useEnhancedRBAC,
  RoleRedirect,
...
import {
  testMakeWebhook,
  validateMakeWebhookConfig,
  getWebhookStats,
} from '@/lib/webhooks/make-integration';
  ...
  useEffect(() => {
    const updateStats = () => {
      setSubscriptionStats({
        ...
        activeSubscriptions:
          bookingSubscriptionManager.getActiveSubscriptions(),
      });
    };
      ...
      <div className='container mx-auto p-6 space-y-6'>
        ...
        <div className='flex items-center justify-between'>
          <div>
            <h1 className='text-3xl font-bold mb-2'>
              Real-time Booking Events Demo
            </h1>
            <p className='text-gray-600'>
              Comprehensive demonstration of real-time subscriptions and
          ...
          <div className='flex items-center gap-4'>
            <Badge
              variant={
                subscriptionStats.activeCount > 0 ? 'default' : 'secondary'
              }
            >
        ...
        <Tabs defaultValue='live-events' className='space-y-6'>
          <TabsList className='grid w-full grid-cols-5'>
            ...
            <TabsTrigger value='subscription-manager'>
              Subscriptions
            </TabsTrigger>
                ...
                <CardContent className='space-y-4'>
                  ...
                  {!selectedBookingId && (
                    <Alert>
                      ...
                      <AlertDescription>
                        Enter a booking ID above to start monitoring real-time
                        events for that specific booking.
                      </AlertDescription>
                    </Alert>
                  )}
                </CardContent>
                  ...
                  {webhookConfig && (
                    <div className='space-y-3'>
                      <div className='flex items-center justify-between'>
                        ...
                        <Badge
                          variant={
                            webhookConfig.isValid ? 'default' : 'destructive'
                          }
                        >
                    ...
                    <div className='space-y-4'>
                      ...
                      {webhookStats.lastSentAt && (
                        <div className='text-sm text-gray-500'>
                          Last sent:{' '}
                          {new Date(webhookStats.lastSentAt).toLocaleString()}
                        </div>
                      )}
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                    ...
                    <div className='text-center p-4 bg-blue-50 rounded'>
                      <div className='text-3xl font-bold text-blue-600'>
                        {
                          subscriptionStats.activeSubscriptions.filter(s =>
                            s.startsWith('booking_events:')
                          ).length
                        }
                      </div>
                      <div className='text-sm text-blue-600'>
                ...
                <CardContent>
                  <div className='space-y-4'>
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      <Badge
                        variant={
                          webhookConfig?.isValid ? 'default' : 'secondary'
                        }
                      >
                        <Webhook className='h-3 w-3 mr-1' />
                        {webhookConfig?.isValid
                          ? 'Configured'
                          : 'Not Configured'}
                      </Badge>
                    </div>
