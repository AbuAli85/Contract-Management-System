    ...
    <div className="container mx-auto p-8 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Add a new service to the system. The service will be sent for approval.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fill in the service information below. The service will be created and sent for approval.
          </CardDescription>
        </CardHeader>
        <CardContent>
