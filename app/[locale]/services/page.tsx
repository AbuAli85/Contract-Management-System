...
import { Loader2, Plus, RefreshCw, Clock, CheckCircle, XCircle, AlertCircle } from "lucide-react"
        ...
        (payload) => {
          ...
          if (payload.eventType === "INSERT") {
            ...
            toast({
              ...
              description: "A new service has been created and is pending approval.",
              variant: "default",
            })
        ...
        <Card>
          <CardContent className="p-8 text-center">
            <div className="text-muted-foreground">
              ...
              <p className="mb-4">Get started by creating your first service.</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
               ...
               <div className="text-center">
                 <div className="text-2xl font-bold text-green-600">
                   {filteredServices.filter(s => s.status === "approved" || s.status === "active").length}
                 </div>
