    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <div className="mt-4 rounded-lg border border-green-200 bg-green-50 p-4">
          <p className="font-medium text-green-800">✅ Sidebar is working!</p>
          <p className="text-sm text-green-600">Check the left side for the navigation menu</p>
        </div>
      </div>

      <div className="rounded-lg bg-white p-6 shadow">
        <h2 className="mb-4 text-xl font-semibold">Sidebar Features:</h2>
        <ul className="space-y-2 text-sm">
          <li>
            ✅ <strong>Responsive Design:</strong> Works on desktop and mobile
          </li>
          <li>
            ✅ <strong>Mobile Menu:</strong> Hamburger button for mobile devices
          </li>
          <li>
            ✅ <strong>All Pages:</strong> Complete navigation to all features
          </li>
          <li>
            ✅ <strong>User Info:</strong> Shows logged-in user information
          </li>
          <li>
            ✅ <strong>Smooth Animations:</strong> Smooth open/close transitions
          </li>
          <li>
            ✅ <strong>Auto-close:</strong> Closes on mobile after navigation
          </li>
        </ul>
      </div>

      <div className="rounded-lg bg-white p-6 shadow">
        <h2 className="mb-4 text-xl font-semibold">Available Pages:</h2>
      ...
      <div className="text-center">
        <p className="text-sm text-gray-500">
          Try navigating using the sidebar on the left! On mobile, use the hamburger menu button.
        </p>
      </div>
    </div>
  )
