  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-600">Testing the enhanced RBAC provider integration</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Current user's role and company data</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium text-gray-500">Company Member:</label>
              <div className="mt-1">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Available permissions for current role</CardDescription>
          </CardHeader>
          <CardContent>
