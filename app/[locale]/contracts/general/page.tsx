...
export const metadata: Metadata = {
  ...
  description: 'Create professional general contracts with automated processing via Make.com integration',
  keywords: ['contract generation', 'general contracts', 'make.com', 'automation', 'document generation'],
};
