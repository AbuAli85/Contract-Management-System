    ...
    <div className="container mx-auto space-y-6 py-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">View all rejected contracts and their reasons</p>
        </div>
      </div>
        ...
        <CardContent>
          {filteredContracts.length === 0 ? (
            <div className="flex h-32 flex-col items-center justify-center">
              ...
              <p className="text-muted-foreground">No rejected contracts found</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-xs text-muted-foreground">
                        ...
                        <span>
                          Rejected: {formatDate(contract.rejected_at || contract.created_at)}
                        </span>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
