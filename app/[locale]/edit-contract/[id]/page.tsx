            ...
            <TabsContent value="parties">
              <Card className="shadow-lg transition-all duration-300">
                ...
                <CardContent className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleInputChange("first_party_name_en", e.target.value)
                            }
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleInputChange("first_party_name_ar", e.target.value)
                            }
                  ...
                  <div className="mt-8">
                    <h3 className="border-b pb-2 text-lg font-semibold text-gray-900">Promoter</h3>
                    {contract?.promoter ? (
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-blue-700">
                          You can update document URLs here. For security, actual file uploads
                          should be handled through your document management system.
                        </p>
                      </div>
                    </div>
                  </div>
