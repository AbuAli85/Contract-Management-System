                  ...
                  <div key={webhookType} className='border rounded-lg p-4'>
                    <div className='flex items-center justify-between mb-4'>
                      ...
                      <Button
                        ...
                        disabled={
                          !isConfigured || testResult?.status === 'testing'
                        }
                        size='sm'
                    ...
                    {testResult && (
                      <div
                        className={`p-3 rounded-lg border ${getStatusColor(testResult.status)}`}
                      >
                    ...
                    {!isConfigured && (
                      <div className='p-3 bg-yellow-50 border border-yellow-200 rounded-lg'>
                        <p className='text-sm text-yellow-800'>
                          ⚠️ This webhook is not configured. Add the environment
                          variable to test.
                        </p>
                      </div>
                    )}
