    ...
    <div className='container mx-auto p-8 max-w-6xl'>
      <div className='mb-8'>
        ...
        <p className='text-muted-foreground'>
          Test all the service management enhancements: loading skeletons, error
          boundaries, search/filters, and role-based approval buttons.
        </p>
      </div>
      ...
      <div className='grid gap-6'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Test the error boundary component</CardDescription>
          </CardHeader>
          <CardContent>
            <ErrorBoundary>
              <div className='p-4 bg-green-50 border border-green-200 rounded'>
                <p className='text-green-800'>
                  This content is wrapped in an error boundary. If an error
                  occurs, it will be caught and displayed with a retry option.
                </p>
              </div>
            </ErrorBoundary>
          </CardContent>
