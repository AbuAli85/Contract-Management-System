    ...
    <div className='container mx-auto p-6 space-y-8'>
      ...
      <div className='text-center space-y-4'>
        ...
        <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
          A comprehensive notification center with real-time updates, smart
          filtering, priority management, and full CRUD operations
        </p>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
        ...
        <div className='space-y-4'>
          ...
          <p className='text-muted-foreground'>
            Compact notifications widget for the main dashboard with quick
            actions
          </p>
        ...
        <div className='space-y-4'>
          ...
          <p className='text-muted-foreground'>
            Complete notification management with filtering, bulk actions, and
            settings
          </p>
          <NotificationsCenter
            maxHeight='500px'
