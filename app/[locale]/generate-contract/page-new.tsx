      ...
      try {
        ...
        setConfig({
          ...
          getEnhancedContractTypeConfig:
            configModule.getEnhancedContractTypeConfig,
          loading: false,
          error: null,
        });
      } catch (error) {
...
const featureComparison = {
  standard: {
    ...
    description:
      'Battle-tested form with enterprise-grade validation and full compliance support',
    features: [
  ...
  enhanced: {
    ...
    description:
      'Next-generation interface with AI-powered insights and modern workflow design',
    features: [
...
export default function GenerateContractPage() {
  ...
  const [formProgress, setFormProgress] = useState<FormProgress>({
    ...
    sections: [
      ...
      {
        name: 'Promoter Required Information',
        completed: false,
        required: true,
      },
  ...
  const initialInsights: ContractInsight[] = [
    ...
    },
    {
      ...
      description:
        'Form automatically shows required fields based on contract type selection.',
      priority: 'medium',
    },
    {
      type: 'warning',
      ...
      description:
        'Contract dates are validated to ensure compliance with legal requirements.',
      priority: 'high',
    },
  ];
      ...
      try {
        ...
        toast({
          ...
          description: `Selected ${
            getEnhancedContractTypeConfig(type)?.name || type
          } contract template.`,
        });
      } catch (error) {
  ...
  const updateInsightsForContractType = useCallback(
    (type: string) => {
      try {
          ...
          const contractSpecificInsights: ContractInsight[] = [
            {
              ...
              description:
                typeConfig.description || 'Contract template selected',
              priority: 'medium' as const,
            },
            {
              type: 'success',
              title: 'Template Ready',
              description: `This template includes ${
      ...
      try {
        setFormProgress(prevProgress => {
          ...
          const percentage = Math.round(
            (completedCount / prevProgress.total) * 100
          );
  ...
  const contractTypesConfig = filteredContractTypes.reduce(
    (acc, type) => {
              ...
              <div className='relative z-10 text-center space-y-6'>
                ...
                >
                  ...
                  <p className='mt-4 text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed'>
                    ...
                    insights, advanced validation, and compliance with Oman
          ...
          <div className='space-y-3'>
            ...
            <div className='text-xs text-slate-500'>
              {formProgress.percentage === 100
                ? '🎉 Ready to generate!'
                : `${100 - formProgress.percentage}% remaining`}
            </div>
          </div>
      ...
      <CardHeader>
        <CardTitle className='flex items-center gap-3 text-2xl'>
          ...
          <div>
            ...
            <div className='text-sm text-slate-500 font-normal'>
              Choose from our comprehensive template library
            </div>
          </div>
        </CardTitle>
      </CardHeader>
          ...
          {Object.keys(contractTypesConfig).length > 0 ? (
                ...
                <div className='space-y-3'>
                  {(types as any[]).map((type: any) => (
                    <motion.div
                      ...
                      onClick={() =>
                        !isLoading && handleContractTypeSelect(type.id)
                      }
                    >
            ...
            <div className='col-span-full text-center py-12'>
              ...
              <p className='text-slate-600 mb-4'>
                No contract types found in this category.
              </p>
              <Button
                variant='outline'
                onClick={() => setActiveCategory('all')}
...
const GeneratorSection = ({
  ...
  <div className='space-y-6'>
    ...
    <Card className='border-0 shadow-lg bg-white/60 backdrop-blur-sm'>
      ...
      <CardContent>
        <Tabs
          value={useEnhancedForm ? 'enhanced' : 'standard'}
          className='w-full'
        >
          ...
          <DynamicEnhancedContractForm
            onSuccess={() => {
              ...
              toast({
                ...
                description:
                  'Your contract has been generated and saved with all validations passed.',
              });
            }}
            onError={(error: any) => {
    ...
    <div className='flex items-center justify-between'>
      <div>
        ...
        <p className='text-slate-600'>
          Advanced contract analytics and smart insights
        </p>
      </div>
      <Button
        variant='outline'
      ...
      {showAIInsights && (
        ...
        >
          <Card className='border-0 shadow-lg bg-gradient-to-br from-purple-50/50 to-blue-50/50 backdrop-blur-sm'>
            ...
            <CardContent className='p-0'>
              <DynamicContractIntelligence
                contractId={selectedContractType || 'sample-contract-123'}
              />
            </CardContent>
          </Card>
        </motion.div>
