...
export default function DocumentGenerationPage() {
  ...
  const selectedTemplateData = templates.find(tpl => tpl.key === selectedTemplate);
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">Generate contracts, letters, and other HR documents</p>
        </div>
        <Button onClick={handleGenerate} disabled={generating || !selectedEmployee || !selectedTemplate}>
          {generating ? (
            <>
          ...
          <CardContent className="space-y-4">
            ...
            {selectedEmployeeData && selectedTemplateData && (
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                  <p><strong>Employee:</strong> {selectedEmployeeData.full_name}</p>
                  <p><strong>Template:</strong> {selectedTemplateData.display_name}</p>
                  <p><strong>Language:</strong> {selectedTemplateData.language.toUpperCase()}</p>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Optional: Add custom data to be included in the document template
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-3">
              ...
              {generatedDocs.length === 0 && (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-sm">Generate your first document using the form</p>
                </div>
              )}
            </div>
          </CardContent>
