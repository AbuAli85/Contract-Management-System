    ...
    <div className="container mx-auto space-y-6 py-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Manage communications with all parties</p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>This month's communication metrics</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Send a message to selected parties</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
