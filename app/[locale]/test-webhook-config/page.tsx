  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mx-auto max-w-4xl space-y-6">
        <div>
          <h1 className="mb-2 text-3xl font-bold">Make.com Webhook Configuration Test</h1>
          ...
          <CardContent>
            <div className="space-y-4">
              <Alert>
                ...
                <AlertDescription>
                  The current webhook URL is returning 404 errors. This means the URL is either
                  incorrect or the Make.com scenario is not properly configured.
                </AlertDescription>
              </Alert>

              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 font-semibold">Current Webhook URL</h3>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="mb-2 font-semibold">Environment Variable</h3>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <Button onClick={testWebhook} disabled={isTesting || !webhookUrl} className="w-full">
                {isTesting ? (
                  <>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                <h3 className="mb-2 font-semibold">1. Create Make.com Scenario</h3>
              ...
              <div>
                <h3 className="mb-2 font-semibold">2. Configure Environment Variable</h3>
                <ol className="list-inside list-decimal space-y-1 text-sm">
                  <li>
                    Add <code>MAKE_WEBHOOK_URL</code> to your environment variables
                  </li>
              ...
              <div>
                <h3 className="mb-2 font-semibold">3. Test the Integration</h3>
                <ol className="list-inside list-decimal space-y-1 text-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-inside list-disc space-y-1 text-sm">
                  <li>
                    <strong>404 Error:</strong> Webhook URL is incorrect or scenario is not active
                  </li>
                  <li>
                    <strong>403 Error:</strong> Webhook is not public or requires authentication
                  </li>
                  <li>
                    <strong>500 Error:</strong> Make.com scenario has an error
                  </li>
                  <li>
                    <strong>Timeout:</strong> Scenario is taking too long to respond
                  </li>
                </ul>
              </div>

              <div>
                <h3 className="mb-2 font-semibold">Make.com Scenario Requirements:</h3>
                <ul className="list-inside list-disc space-y-1 text-sm">
