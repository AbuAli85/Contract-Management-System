    ...
    <div className='container mx-auto p-6 space-y-6'>
      <div className='text-center space-y-2'>
        ...
        <p className='text-gray-600'>
          Review and fix booking upsert implementation
        </p>
      </div>
        ...
        <CardContent>
          {schemaChecks ? (
            <div className='space-y-4'>
              ...
              {/* Error Details */}
              {Object.entries(schemaChecks).some(
                ([_, check]) => check?.error
              ) && (
                <div>
                  ...
                  <div className='space-y-2'>
                    {Object.entries(schemaChecks).map(
                      ([key, check]) =>
                        check?.error && (
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          <Alert>
            <AlertDescription>
              Test the booking upsert functionality with real data to verify
      ...
      <Card>
        ...
        <CardContent>
          <div className='space-y-4'>
            <Alert>
              <AlertDescription>
                If you see issues above, run the migration to fix the database
                schema:
              </AlertDescription>
            </Alert>
...
supabase db push`}
              ...
              <div>
                ...
                <div className='bg-blue-50 p-3 rounded text-sm'>
                  ...
                  <p>
                    ...
                    <code>
                      supabase/migrations/20250117_fix_booking_issues.sql
                    </code>
                  </p>
            ...
            <div>
              ...
              <ul className='list-disc list-inside space-y-1 text-sm'>
                <li>
                  Adds unique constraint on <code>booking_number</code>
                </li>
                <li>
                  Adds <code>scheduled_start</code> and{' '}
                  <code>scheduled_end</code> columns
                </li>
