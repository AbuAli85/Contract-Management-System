        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Top performing promoters this month</CardDescription>
            </div>
            <div className="flex items-center gap-2">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 transform text-gray-400" />
                <Input placeholder="Search promoters..." className="w-64 pl-10" />
              </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">ID: PRM-{1000 + i}</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {i === 1 ? "Gold" : i === 2 ? "Silver" : i === 3 ? "Bronze" : "Standard"}{" "}
                      Level
                    </p>
                  </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Monthly performance trends over the last 12 months</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between rounded-lg bg-green-50 p-3">
                ...
                <Badge className="bg-green-100 text-green-800">45 promoters</Badge>
              </div>
              <div className="flex items-center justify-between rounded-lg bg-blue-50 p-3">
                <span className="font-medium">Good (8.0-8.9)</span>
                <Badge className="bg-blue-100 text-blue-800">89 promoters</Badge>
              </div>
