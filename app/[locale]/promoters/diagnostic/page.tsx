        ...
        <CardContent className='space-y-4'>
          ...
          <Card className='bg-blue-50 border-blue-200'>
            ...
            <CardContent className='text-sm space-y-2'>
              <p>
                <strong>If Health Check fails:</strong> API routes not deployed
                or not accessible
              </p>
              <p>
                <strong>If Main API returns empty array:</strong> Database
                connection or RLS policy issue
              </p>
              <p>
                <strong>If Test API fails:</strong> Deployment issue or routing
                problem
              </p>
              <p>
                <strong>If User Permissions fails:</strong> Authentication or
