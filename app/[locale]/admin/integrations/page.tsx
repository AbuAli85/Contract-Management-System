            ...
            <div className="space-y-2">
              ...
              <Select value={filterType} onValueChange={setFilterType}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="serviceCreation">Service Creation</SelectItem>
                  <SelectItem value="bookingCreated">Booking Created</SelectItem>
                  <SelectItem value="trackingUpdated">Tracking Updated</SelectItem>
                  <SelectItem value="paymentSucceeded">Payment Succeeded</SelectItem>
                </SelectContent>
              </Select>
            </div>
