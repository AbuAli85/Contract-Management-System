...
export default function RegisterNewUserPage() {
  ...
  const handleRegister = async () => {
    ...
    try {
      console.log("🔐 New Registration - Starting:", formData.email, formData.role)
      ...
      if (publicUserError) {
        ...
        console.log("⚠️ Auth user created but public user failed - this is fixable")
      } else {
      ...
      setMessage(`✅ Registration successful! Account created for ${formData.email}`)
      setStep('success')
            ...
            <Alert className="border-green-200 bg-green-50">
              <AlertDescription className="text-green-800">
                <div className="space-y-2">
                  <p><strong>Account Created:</strong> {formData.email}</p>
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <p className="text-sm text-gray-600">Create a new account with proper role assignment</p>
        </CardHeader>
            ...
            <div>
              ...
              <div className="mt-1">
                <Badge variant="outline" className="text-xs">
                  {formData.role === 'provider' && "Can offer digital marketing services"}
