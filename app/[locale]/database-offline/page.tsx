      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Alert className="border-orange-200 bg-orange-50">
          ...
          <AlertDescription className="text-orange-800">
            <strong>Service Notice:</strong> Our database is currently experiencing connectivity issues. 
            We've activated demo mode so you can explore all features without interruption.
          </AlertDescription>
        </Alert>
        ...
        <div className="text-center text-sm text-gray-500">
          <p>
            Demo mode provides full access to application features with sample data. 
            All functionality is preserved while database connectivity is restored.
          </p>
        </div>
      </div>
    </div>
