    ...
    try {
      ...
      if (data.success) {
        ...
        setResult({
          ...
          message:
            'Booking created and Make.com webhook triggered successfully!',
        });
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Fill out the form to create a new booking. The Make.com webhook
            ...
            <CardContent>
              {result ? (
                ...
                <div className='text-center py-8 text-gray-500'>
                  ...
                  <p>
                    No results yet. Create a booking to see webhook results.
                  </p>
                </div>
              )}
            </CardContent>
