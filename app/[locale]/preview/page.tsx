        ...
        <div className='mx-auto max-w-7xl space-y-6'>
          ...
          <div className='space-y-4 text-center'>
            ...
            <p className='mx-auto max-w-3xl text-lg text-gray-600'>
              From boring basic interface to professional, engaging, and
              beautiful UI/UX. See how we transformed the Contract Management
              System.
            </p>
            ...
            <TabsContent value='admin' className='space-y-4'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Professional admin interface with real-time metrics,
                    attendance heatmap, and performance tracking
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value='promoter' className='space-y-4'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Personal dashboard with task management, achievements,
                    leaderboard rank, and performance insights
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='overflow-hidden rounded-lg border bg-white'>
            ...
            <TabsContent value='onboarding' className='space-y-4'>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Professional onboarding experience with file upload,
                    requirements checklist, and progress tracking
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='overflow-hidden rounded-lg border bg-white'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                See the dramatic improvement from the old basic interface to the
                ...
                <div className='space-y-4'>
                  ...
                  <ul className='space-y-3 text-sm text-gray-600'>
                    ...
                    <li className='flex items-start gap-2'>
                      <span className='mt-1 text-red-500'>•</span>
                      <span>
                        Empty states with "No communications logged yet"
                      </span>
                    </li>
                    <li className='flex items-start gap-2'>
                      <span className='mt-1 text-red-500'>•</span>
          ...
          <Card className='border-green-200 bg-gradient-to-r from-green-50 to-blue-50'>
            ...
            <CardContent className='space-y-4 text-center'>
              ...
              <p className='text-sm text-gray-600'>
                All the beautiful UI components you see here are fully
                functional
              </p>
            </CardContent>
          </Card>
