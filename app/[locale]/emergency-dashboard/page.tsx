...
import { Building2, FileText, Users, BarChart3, Bell, User, Plus, RefreshCw } from "lucide-react"
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-semibold text-slate-900">Client Overview (No API Calls)</h2>
      </div>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-semibold text-slate-900">Quick Actions (Static)</h2>
      </div>
        ...
        <div className="flex flex-col gap-6 mb-8">
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-900">Emergency Client Dashboard</h1>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
            ...
            <p className="text-red-800 mb-4">
              This dashboard is running in emergency mode to stop infinite API loops. 
              All authentication and external API calls have been disabled.
            </p>
          ...
          <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
            <div className="text-center">
              ...
              <p className="text-green-800">
                If you're seeing this and no infinite requests in the console, the loop issue has been isolated.
              </p>
            </div>
          </div>
        </div>
