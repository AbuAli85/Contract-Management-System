...
import { Loader2, User, Shield, Building2, Factory, Settings } from "lucide-react"
    ...
    async function fetchUserRole() {
      ...
      try {
        ...
        toast({
          ...
          description: "Using default user role. Please contact support if this persists.",
          variant: "destructive"
        })
      } finally {
        setLoading(false)
        ...
        <Card className="w-full max-w-md mx-4">
          <CardContent className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-sm text-gray-600 text-center mb-4">
              Unable to determine your dashboard access level. Please contact support.
            </p>
      ...
      <Card className="w-full max-w-lg mx-4">
        <CardHeader className="text-center">
          <div className="flex justify-center mb-4">
            <div className={`w-16 h-16 rounded-full flex items-center justify-center ${config.color}`}>
              {config.icon}
            </div>
          </div>
        ...
        <CardContent className="text-center space-y-6">
          <div className="space-y-2">
            <Badge variant="secondary" className={`text-sm px-3 py-1 ${config.color}`}>
              {config.displayName}
            </Badge>
