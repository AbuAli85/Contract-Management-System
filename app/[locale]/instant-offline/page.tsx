        ...
        <CardContent className="space-y-6">
          <Alert className="border-blue-200 bg-blue-50">
            ...
            <AlertDescription className="text-blue-800">
              <strong>Good News!</strong> We've detected database connectivity issues and 
              are automatically switching you to our fully functional demo mode.
            </AlertDescription>
          </Alert>
          ...
          <div className="space-y-3">
            <h4 className="font-semibold text-center">Available in Demo Mode:</h4>
