...
import { CheckCircle, XCircle, AlertTriangle, Database, User, Key } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Connection Status */}
        <Card className={`border-2 ${connectionStatus === 'connected' ? 'border-green-200 bg-green-50' : connectionStatus === 'error' ? 'border-red-200 bg-red-50' : 'border-yellow-200 bg-yellow-50'}`}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <Badge className={connectionStatus === 'connected' ? 'bg-green-500' : connectionStatus === 'error' ? 'bg-red-500' : 'bg-yellow-500'}>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    ✅ Confirmed: {currentUser.email_confirmed_at ? 'Yes' : 'No'} | 
          ...
          <CardContent className="space-y-4">
            ...
            <Alert>
              ...
              <AlertDescription>
                ...
                <br />
                <strong>New Signup:</strong> Creates temporary test account for verification
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <Button 
                variant="outline" 
                size="sm"
                onClick={() => window.open('https://reootcngcptfogfozlmz.supabase.co/project/reootcngcptfogfozlmz/auth/users', '_blank')}
              >
                👤 Supabase Users
              </Button>
            </div>
