...
You can try logging in with: ${formData.email}`);
  ...
  const createManualAccount = async () => {
    ...
    try {
      ...
      setError(
        '❌ Manual sync error. Account exists but may need admin setup.'
      );
    } finally {
      setLoading(false);
    }
        ...
        <Card className='w-full max-w-md'>
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='text-xs text-gray-500 text-center border-t pt-2'>
              <p>
                Your account is created! Try logging in with your credentials.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className='w-full max-w-md'>
        <CardHeader className='text-center'>
          ...
          <p className='text-sm text-gray-600'>
            Working registration system without complex APIs
          </p>
        </CardHeader>
            ...
            <div>
              ...
              <div className='mt-1'>
                <Badge variant='outline' className='text-xs'>
                  {formData.role === 'provider' &&
                    '✅ Direct Supabase auth + manual DB sync'}
                  {formData.role === 'client' &&
                    '✅ Working client account creation'}
                  {formData.role === 'admin' &&
