  ...
  return (
    <DashboardAuthGuard locale={locale}>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 animate-in fade-in duration-700">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 animate-in slide-in-from-bottom-4 duration-500 delay-200">
          {/* Left Column - Quick Actions */}
          <div className="lg:col-span-5 animate-in slide-in-from-left-4 duration-500 delay-300">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8 hover:shadow-lg transition-all duration-300 group">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-8 h-8 bg-gradient-to-br from-green-600 to-emerald-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="lg:col-span-7 animate-in slide-in-from-right-4 duration-500 delay-400">
            <div className="grid grid-cols-1 gap-8">
              {/* Notifications */}
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8 hover:shadow-lg transition-all duration-300 group">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-8 h-8 bg-gradient-to-br from-orange-600 to-red-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <AlertTriangle className="h-4 w-4 text-white" />
                  </div>
                  <h2 className="text-xl font-semibold text-slate-900">Alerts & Notifications</h2>
                  <div className="ml-auto flex items-center gap-2">
                    {notifications.length > 0 && (
                      <Badge variant="destructive" className="bg-red-100 text-red-800 border-red-200 hover:bg-red-200 transition-colors duration-200">
                        {notifications.filter(n => n.priority === 'high').length} High Priority
                      </Badge>
                    )}
                    <Button 
              ...
              {/* Recent Activities */}
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8 hover:shadow-lg transition-all duration-300 group animate-in slide-in-from-bottom-4 duration-500 delay-500">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-8 h-8 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <Calendar className="h-4 w-4 text-white" />
                  </div>
                  <h2 className="text-xl font-semibold text-slate-900">Recent Activities</h2>
                  <div className="ml-auto flex items-center gap-2">
                    {activities.length > 0 && (
                      <Badge variant="secondary" className="bg-purple-100 text-purple-800 border-purple-200 hover:bg-purple-200 transition-colors duration-200">
                    ...
                    <Button 
                      ...
                      size="sm" 
                      onClick={handleRefresh}
                      className="hover:bg-purple-50 border-purple-200 text-purple-700 hover:scale-105 transition-all duration-200"
                    >
                      Refresh
                    </Button>
                  </div>
