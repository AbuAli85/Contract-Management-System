    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Pending Actions</CardDescription>
        ...
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Last Login</CardDescription>
        ...
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Account Age</CardDescription>
      ...
      <div className="space-y-4">
        {contracts.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-500">Your contracts will appear here</p>
          </div>
        ) : (
...
export default function UserDashboard({ params }: { params: { locale: string } }) {
  const { locale } = params
