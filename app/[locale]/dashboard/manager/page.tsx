  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-semibold text-slate-900">Management Actions</h2>
      </div>
          ...
          <Card className="hover:shadow-md transition-all duration-200 border-slate-200/60 group-hover:border-blue-300">
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900">Contract Review</h3>
          ...
          <Card className="hover:shadow-md transition-all duration-200 border-slate-200/60 group-hover:border-orange-300">
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900">Client Relations</h3>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-semibold text-slate-900">Management Overview</h2>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Team Members</CardDescription>
        ...
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Pending Approvals</CardDescription>
        ...
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Team Efficiency</CardDescription>
        ...
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Client Satisfaction</CardDescription>
              <Award className="w-8 h-8 text-yellow-600" />
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.clientSatisfaction}/5.0</div>
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-semibold text-slate-900">Recent Team Activities</h2>
        </div>
      ...
      <div className="space-y-4">
        {activities.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-500">Team activities will appear here</p>
          </div>
        ) : (
...
export default function ManagerDashboard({ params }: { params: { locale: string } }) {
  const { locale } = params
          ...
          <div className="flex flex-col gap-6 mb-8">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center">
              <div className="text-sm text-slate-600">
                Welcome back, {profile?.name || user?.email || 'Manager'}
              </div>
