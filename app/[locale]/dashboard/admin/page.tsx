            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Manage users and roles</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Manage clients & providers</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-md transition-all duration-200 border-slate-200/60 group-hover:border-purple-300">
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900">All Contracts</h3>
                  <p className="text-sm text-slate-600">System-wide contracts</p>
                </div>
              </div>
            </CardContent>
          </Card>
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200/60 p-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Total Contracts</CardDescription>
        ...
        <Card className="border-slate-200/60">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">{Math.round((stats.activeContracts/stats.totalContracts)*100)}% of total</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Total Promoters</CardDescription>
              <UserCheck className="w-8 h-8 text-indigo-600" />
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-slate-200/60">
          <CardHeader className="space-y-0 pb-2">
            <div className="flex justify-between items-center">
              <CardDescription className="text-sm font-medium">Companies</CardDescription>
