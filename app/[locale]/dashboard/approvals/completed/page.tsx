    ...
    <div className="container mx-auto space-y-6 py-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">History of all completed contract reviews</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>View all completed contract reviews and approvals</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
