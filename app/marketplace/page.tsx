  ...
  const featuredServices: FeaturedService[] = [
    {
      ...
      description:
        'Comprehensive SEO analysis with actionable recommendations to boost your rankings',
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1626785774625-0b1c2c4eab67?w=400&h=250&fit=crop',
      featured: true,
    },
    {
      id: '3',
      ...
      description:
        'Custom React.js web application with modern design and functionality',
  ...
  const testimonials = [
    {
      ...
      avatar:
        'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=50&h=50&fit=crop&crop=face',
      content:
        'Found the perfect developer for our project. The quality of work exceeded our expectations and the platform made collaboration seamless.',
      rating: 5,
    },
    {
      name: 'Lisa Park',
      ...
      avatar:
        'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=50&h=50&fit=crop&crop=face',
      content:
        'The SEO services I received boosted our organic traffic by 300%. Professional, reliable, and results-driven.',
      rating: 5,
    },
    {
      name: 'David Wilson',
      ...
      content:
        'Secure payments and milestone-based releases gave me confidence. The escrow system protected both parties perfectly.',
      rating: 5,
    },
  ];
      ...
      <section className='relative bg-gradient-to-br from-blue-600 via-purple-700 to-blue-800 text-white overflow-hidden'>
        ...
        <div className='relative container mx-auto px-4 py-16 lg:py-24'>
          <div className='text-center max-w-4xl mx-auto'>
            ...
            >
              Connect with verified professionals for digital marketing,
              development, design, and more. Secure payments and quality
              guaranteed.
            </motion.p>
            ...
            {[
              {
                ...
                description:
                  'Browse through thousands of services or post your project requirements',
              ...
              },
              {
                ...
                description:
                  'Pay securely through our escrow system. Funds are released upon completion',
              ...
              },
              {
                ...
                description:
                  'Collaborate with your chosen provider and receive high-quality results',
      ...
      <section className='py-16 bg-white'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              Join thousands of satisfied clients who found success on our
              platform
            </p>
          </div>
