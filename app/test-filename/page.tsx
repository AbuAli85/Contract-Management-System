        ...
        <CardContent className='space-y-4'>
          ...
          <div className='bg-gray-100 p-4 rounded-lg'>
            ...
            <p>
              ...
              {testData.promoterName
                .replace(/[^a-zA-Z0-9\s]/g, '_')
                .replace(/\s+/g, '_')}
              _{testData.idCardNumber.replace(/[^a-zA-Z0-9]/g, '_')}.jpg
            </p>
            <p>
              ...
              {testData.promoterName
                .replace(/[^a-zA-Z0-9\s]/g, '_')
                .replace(/\s+/g, '_')}
              _{testData.passportNumber.replace(/[^a-zA-Z0-9]/g, '_')}.jpg
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <ol className='list-decimal list-inside space-y-2'>
            <li>
              Fill in the test data above (promoter name, ID number, passport
              number)
            </li>
            <li>Open browser DevTools (F12) and go to Console tab</li>
            <li>
              Try uploading a file using one of the DocumentUpload components
            </li>
          ...
          <div className='mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded'>
            <p className='text-sm text-yellow-800'>
              <strong>Expected behavior:</strong> Console should show the
              promoter name, ID numbers, and generated filename. If you see
              "Unknown_Promoter" or "NO_ID", it means the form data isn't being
              passed correctly.
            </p>
          </div>
        </CardContent>
