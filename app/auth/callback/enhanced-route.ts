...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const errorDetails = SupabaseErrorHandler.handleError(error, "auth.callback", requestId)
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const errorDetails = SupabaseErrorHandler.handleError(error, "auth.callback_post", requestId)
