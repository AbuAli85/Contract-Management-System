...
if (!jsonFilePath) {
  ...
  console.log(
    '  2. Click on: contract-generator@nth-segment-475411-g1.iam.gserviceaccount.com'
  );
...
try {
  ...
  console.log(
    '   - Keep GOOGLE_DOCS_TEMPLATE_ID the same: 1dG719K4jYFrEh8O9VChyMYWblflxW2tdFp2n4gpVhs0'
  );
  ...
  console.log(
    `   - Make sure this email is listed: ${credentials.client_email}`
  );
  ...
  const outputFile = path.join(
    process.cwd(),
    'UPDATED_SERVICE_ACCOUNT_KEY.txt'
  );
