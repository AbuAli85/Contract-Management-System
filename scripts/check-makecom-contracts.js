...
const enabledTypes = contractTypes.filter((type) => type.makecomTemplateId && type.isActive)
...
const notEnabled = contractTypes.filter((type) => !type.makecomTemplateId || !type.isActive)
