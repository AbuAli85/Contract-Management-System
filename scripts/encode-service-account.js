...
if (!filePath) {
  ...
  console.log('Usage: node scripts/encode-service-account.js path/to/service-account.json');
  process.exit(1);
}
...
try {
  ...
  console.log('   1. Create environment variable: GOOGLE_SERVICE_ACCOUNT_KEY_BASE64');
