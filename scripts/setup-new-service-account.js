...
if (!jsonFilePath) {
  ...
  console.log('Usage: node scripts/setup-new-service-account.js path/to/new-service-account.json\n');
  console.log('Example:');
  console.log('  node scripts/setup-new-service-account.js ~/Downloads/nth-segment-475411-g1-abc123.json');
...
`;
  ...
  console.log('🎯 This new service account should resolve the storage quota issue!');
