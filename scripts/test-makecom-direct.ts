...
async function testMakecomDirect() {
  ...
  const testPayload = {
    ...
    promoter_id_card_url:
      'https://via.placeholder.com/300x200/0066CC/FFFFFF?text=ID+Card',
    promoter_passport_url:
      'https://via.placeholder.com/300x200/CC6600/FFFFFF?text=Passport',
    ...
    second_party_logo:
      'https://via.placeholder.com/200x100/009900/FFFFFF?text=Logo',
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log(
        '✅ Test complete! Check your Make.com scenario execution history.'
      );
      console.log(
        '📊 If successful, you should see a PDF generated in your Google Drive.'
      );
    } else {
