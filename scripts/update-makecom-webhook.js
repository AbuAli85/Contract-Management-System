...
const newWebhookUrl = "https://hook.eu2.make.com/71go2x4zwsnha4r1f4en1g9gjxpk3ts4"

// Update MAKE_WEBHOOK_URL
if (envContent.includes("MAKE_WEBHOOK_URL=")) {
  envContent = envContent.replace(/MAKE_WEBHOOK_URL=.*/g, `MAKE_WEBHOOK_URL=${newWebhookUrl}`)
...
console.log("✅ Google Docs template ID updated to: 1dzYQ_MDstiErG9O1yP87_bVXvDPQbe8V")
