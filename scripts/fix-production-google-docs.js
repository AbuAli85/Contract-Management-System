...
console.log('1. Check configuration: https://portal.thesmartpro.io/api/debug/google-docs-config');
...
console.log('');
console.log('GOOGLE_SERVICE_ACCOUNT_KEY={"type":"service_account","project_id":"nth-segment-475411-g1",...}');
...
console.log('3. Share with: contract-generator@nth-segment-475411-g1.iam.gserviceaccount.com');
...
console.log('Visit: https://portal.thesmartpro.io/api/debug/google-docs-config');
...
console.log('curl -X POST https://portal.thesmartpro.io/api/contracts/google-docs-generate \\');
console.log('  -H "Content-Type: application/json" \\');
console.log('  -d \'{"promoter_id":"test","first_party_id":"test","second_party_id":"test","contract_type":"full-time-permanent","job_title":"Test","department":"Test","work_location":"Test","basic_salary":1000,"contract_start_date":"2024-01-01","contract_end_date":"2024-12-31"}\'');
console.log('');
...
console.log('Fix: Add GOOGLE_SERVICE_ACCOUNT_KEY and GOOGLE_DOCS_TEMPLATE_ID to your hosting platform');
console.log('');

console.log('🚀 After fixing, your Google Docs integration will work perfectly!');
