...
async function syncAllUserRolesUpsert() {
  try {
    console.log('🔄 Starting UPSERT user role synchronization...\n');
    ...
    // Step 3: Sync each user across all tables using UPSERT
    console.log('🔄 Starting UPSERT synchronization...\n');
