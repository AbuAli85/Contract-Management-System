...
const MISSING_PERMISSIONS = [
  ...
  },
  {
    ...
    description: 'Generate own contracts',
  },
  {
    resource: 'contract',
    action: 'download',
    ...
    description: 'Download own contracts',
  },
  {
    resource: 'contract',
    action: 'approve',
    scope: 'all',
    name: 'contract:approve:all',
  ...
  },
  {
    ...
    description: 'Send contract messages',
  },
  ...
  // Company Management
  {
    ...
    action: 'read',
    scope: 'own',
    name: 'company:read:own',
    description: 'Read own company',
  },
  {
    resource: 'company',
    action: 'read',
    scope: 'organization',
    name: 'company:read:organization',
    description: 'Read organization companies',
  },
  {
    resource: 'company',
    action: 'read',
    scope: 'all',
    name: 'company:read:all',
  ...
  },
  {
    ...
    scope: 'all',
    name: 'data:seed:all',
    description: 'Seed system data',
  },
  {
    resource: 'data',
    action: 'import',
    scope: 'all',
    name: 'data:import:all',
  ...
  // Service Management
  {
    ...
    action: 'create',
    scope: 'own',
    name: 'service:create:own',
    description: 'Create own services',
  },
  {
    resource: 'service',
    action: 'update',
    scope: 'own',
    name: 'service:update:own',
    description: 'Update own services',
  },
  ...
  // Promoter Operations
  {
    ...
    description: 'Read own promoter data',
  },
  {
    resource: 'promoter',
    action: 'manage',
    ...
    description: 'Manage own promoter data',
  },
  ...
  // Party Operations
  {
    ...
    scope: 'own',
    name: 'party:read:own',
    description: 'Read own party data',
  },
  ...
  },
  {
    ...
    action: 'read',
    scope: 'organization',
    name: 'notification:read:organization',
    description: 'Read organization notifications',
  },
  ...
  },
  {
    ...
    action: 'create',
    scope: 'own',
    name: 'notification:create:own',
    description: 'Create own notifications',
  },
  {
    resource: 'audit',
    action: 'read',
  ...
  },
  {
    ...
    action: 'submit',
    scope: 'own',
    name: 'contract:submit:own',
    description: 'Submit own contracts',
  },
];
