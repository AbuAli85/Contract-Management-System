...
async function setupProductsAndLocations() {
  ...
  try {
    ...
    const productsData = [
      {
        ...
        description_en: 'Custom software development services',
        description_ar: 'خدمات تطوير البرمجيات المخصصة',
        category: 'Technology',
      },
      {
        ...
        description_ar: 'تطوير المواقع والتطبيقات الويب',
        category: 'Technology',
      },
      {
        name_en: 'Mobile App Development',
        name_ar: 'تطوير التطبيقات المحمولة',
        description_en: 'iOS and Android mobile application development',
        description_ar: 'تطوير تطبيقات الهواتف المحمولة',
        category: 'Technology',
      },
      {
        name_en: 'IT Consulting',
        name_ar: 'الاستشارات التقنية',
        description_en: 'Information technology consulting services',
        description_ar: 'خدمات الاستشارات التقنية',
        category: 'Consulting',
      },
      {
        ...
        description_ar: 'خدمات التسويق والإعلان الرقمي',
        category: 'Marketing',
      },
      {
        name_en: 'Graphic Design',
        name_ar: 'التصميم الجرافيكي',
        description_en: 'Graphic design and branding services',
        description_ar: 'خدمات التصميم الجرافيكي والعلامة التجارية',
        category: 'Design',
      },
      {
        name_en: 'Content Writing',
        name_ar: 'كتابة المحتوى',
        description_en: 'Content creation and copywriting services',
        description_ar: 'خدمات إنشاء المحتوى والكتابة الإعلانية',
        category: 'Content',
      },
      {
        name_en: 'Translation Services',
        name_ar: 'خدمات الترجمة',
        description_en: 'Professional translation and localization',
        description_ar: 'الترجمة المهنية والتعريب',
        category: 'Language',
      },
      {
        name_en: 'Legal Services',
        name_ar: 'الخدمات القانونية',
        description_en: 'Legal consultation and document preparation',
        description_ar: 'الاستشارات القانونية وإعداد الوثائق',
        category: 'Legal',
      },
      {
        name_en: 'Accounting Services',
        name_ar: 'الخدمات المحاسبية',
        description_en: 'Bookkeeping and financial consulting',
        description_ar: 'المحاسبة والاستشارات المالية',
        category: 'Finance',
      },
    ];
    ...
    if (checkProductsError) {
      console.log(
        '⚠️ Products table does not exist yet. Please run the migration first.'
      );
    ...
    const locationsData = [
      ...
      {
        name_en: 'Abu Dhabi, UAE',
        name_ar: 'أبو ظبي، الإمارات العربية المتحدة',
        country_en: 'United Arab Emirates',
        country_ar: 'الإمارات العربية المتحدة',
        city_en: 'Abu Dhabi',
        city_ar: 'أبو ظبي',
      ...
      {
        name_en: 'Kuwait City, Kuwait',
        name_ar: 'مدينة الكويت، الكويت',
        country_en: 'Kuwait',
        country_ar: 'الكويت',
        city_en: 'Kuwait City',
      ...
      {
        name_en: 'Manama, Bahrain',
        name_ar: 'المنامة، البحرين',
        country_en: 'Bahrain',
        country_ar: 'البحرين',
        city_en: 'Manama',
        city_ar: 'المنامة',
    ...
    const { data: existingLocations, error: checkLocationsError } =
      await supabase.from('locations').select('id').limit(1);

    if (checkLocationsError) {
      console.log(
        '⚠️ Locations table does not exist yet. Please run the migration first.'
      );
      console.log('Run: npx supabase db push');
      ...
      if (locationsInsertError) {
        console.error(
          '❌ Error inserting locations data:',
          locationsInsertError
        );
      } else {
    ...
    if (locationsError) {
      ...
      locations?.forEach(location => {
        console.log(
          `   - ${location.name_en} (${location.name_ar}) - ${location.country_en}`
        );
      });
    }
