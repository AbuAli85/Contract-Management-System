...
try {
  ...
  if (!fs.existsSync(envPath)) {
    console.log('\n❌ .env.local not found!');
    console.log(
      '   Run the setup script first: node setup-env-now.js <json-file>\n'
    );
    process.exit(1);
  }
  ...
  const base64Key = Buffer.from(env.GOOGLE_SERVICE_ACCOUNT_KEY).toString(
    'base64'
  );

  console.log('\n✅ Production Environment Variables Generated!\n');
  console.log(
    'Copy these to your production platform (Vercel, Railway, etc.):\n'
  );
  console.log('-'.repeat(60));
  ...
  console.log(
    "   Add to your server's .env file or export as environment variables\n"
  );
  ...
  console.log(
    '   Template: https://docs.google.com/document/d/1dG719K4jYFrEh8O9VChyMYWblflxW2tdFp2n4gpVhs0/edit'
  );
  console.log(
