        ...
        <CardContent className='space-y-4'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <Switch
              ...
              onCheckedChange={checked =>
                updateSetting('contractExpiry', checked)
              }
          ...
          <div className='flex items-center justify-between'>
            ...
            <Switch
              ...
              onCheckedChange={checked =>
                updateSetting('documentExpiry', checked)
              }
              disabled={!settings.emailNotifications}
            />
          </div>
          ...
          <div className='flex items-center justify-between'>
            ...
            <Switch
              ...
              onCheckedChange={checked =>
                updateSetting('newContracts', checked)
              }
              disabled={!settings.emailNotifications}
            />
          </div>
          ...
          <div className='flex items-center justify-between'>
            <div className='space-y-0.5'>
              <Label htmlFor='contract-approvals'>
            ...
            <Switch
              ...
              onCheckedChange={checked =>
                updateSetting('contractApprovals', checked)
              }
              disabled={!settings.emailNotifications}
            />
          </div>
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='flex items-center justify-between'>
            ...
            <Switch
              ...
              onCheckedChange={checked =>
                updateSetting('monthlyReport', checked)
              }
            />
          </div>
        </CardContent>
