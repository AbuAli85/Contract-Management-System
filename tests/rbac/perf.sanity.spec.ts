...
describe('RBAC Performance Sanity Tests', () => {
  ...
  describe('Guard Performance', () => {
    ...
    it('should have minimal overhead for simple permission checks', async () => {
      ...
      const directResult = await permissionEvaluator.evaluatePermission('test-user', 'user:view:own')
  ...
  describe('Database Query Performance', () => {
    ...
    it('should handle permission evaluation with minimal database calls', async () => {
      ...
      await permissionEvaluator.evaluatePermission('test-user', 'user:view:own')
  ...
  describe('Environment Performance', () => {
    it('should perform well in different enforcement modes', async () => {
      ...
      expect(performanceResults.disabled).toBeLessThan(performanceResults['dry-run'])
      expect(performanceResults.disabled).toBeLessThan(performanceResults.enforce)
    })
