...
export const JOB_TITLES = [
  ...
  {
    value: 'salesman-saleswoman-electronics',
    label: 'Salesman/Saleswoman Electronics',
  },
...
export const CONTRACT_TYPES = [
  ...
  // Standard Oman Labor Law Contract Types
  {
    ...
    label: 'Unlimited Contract (Permanent)',
    category: 'Standard',
  },
  {
    value: 'limited-contract',
    label: 'Limited Contract (Fixed-term)',
    category: 'Standard',
  },
  {
  ...
  {
    value: 'full-time-fixed',
    label: 'Full-time Fixed-term',
    category: 'Employment',
  },
  {
  ...
  {
    value: 'part-time-fixed',
    label: 'Part-time Fixed-term',
    category: 'Employment',
  },
...
export const WORK_LOCATIONS = [
  ...
  // eXtra Locations
  {
    value: 'extra-os1',
    label: 'eXtra Os1',
    description: 'Al Ghubrah South District',
  },
  {
    value: 'extra-os2',
    label: 'eXtra Os2',
    description: 'Al Mawaleh North District',
  },
  ...
  {
    value: 'emax-oasis-mall',
    label: 'Emax - Oasis Mall',
    description: 'Oasis Mall',
  },
  {
  ...
  {
    value: 'emax-mall-of-muscat',
    label: 'Emax - Mall of Muscat',
    description: 'Mall of Muscat',
  },
  {
  ...
  {
    value: 'nesto-al-khoudh',
    label: 'Nesto Hypermarket - Al Khoudh',
    description: 'Al Khoudh',
  },
  {
  ...
  {
    value: 'nesto-al-bandar',
    label: 'Nesto Hypermarket - Al Bandar',
    description: 'Al Bandar',
  },
  {
    value: 'nesto-mabela',
    label: 'Nesto Hypermarket - Mabela',
    description: 'Mabela',
  },
  {
    value: 'nesto-al-ansab',
    label: 'Nesto Hypermarket - Al Ansab',
    description: 'Al Ansab',
  },
  {
    value: 'nesto-al-khadra',
    label: 'Nesto Hypermarket - Al Khadra',
    description: 'Al Khadra',
  },
  {
    value: 'nesto-barka',
    label: 'Nesto Hypermarket - Barka',
    description: 'Barka',
  },
  {
    value: 'nesto-saham',
    label: 'Nesto Hypermarket - Saham',
    description: 'Saham',
  },
  {
  ...
  {
    value: 'nesto-al-hambar',
    label: 'Nesto Hypermarket - Al Hambar',
    description: 'Al Hambar',
  },
  {
    value: 'nesto-seeb',
    label: 'Nesto Hypermarket - Seeb',
    description: 'Seeb',
  },
  {
    value: 'nesto-salalah',
    label: 'Nesto Hypermarket - Salalah',
    description: 'Salalah',
  },
  {
    value: 'nesto-sohar',
    label: 'Nesto Hypermarket - Sohar',
    description: 'Sohar',
  },
  ...
  {
    value: 'lulu-khasab',
    label: 'LuLu Hypermarket - Khasab',
    description: 'Khasab',
  },
  {
    value: 'lulu-sohar',
    label: 'LuLu Hypermarket - Sohar',
    description: 'Sohar',
  },
  {
    value: 'lulu-buraimi',
    label: 'LuLu Hypermarket - Buraimi',
    description: 'Buraimi',
  },
  {
    value: 'lulu-khaburah',
    label: 'LuLu Hypermarket - Khaburah',
    description: 'Khaburah',
  },
  {
    value: 'lulu-al-bidaya',
    label: 'LuLu Hypermarket - Al Bidaya',
    description: 'Al Bidaya',
  },
  {
    value: 'lulu-suwaiq',
    label: 'LuLu Hypermarket - Suwaiq',
    description: 'Suwaiq',
  },
  {
    value: 'lulu-barka',
    label: 'LuLu Hypermarket - Barka',
    description: 'Barka',
  },
  { value: 'lulu-ibri', label: 'LuLu Hypermarket - Ibri', description: 'Ibri' },
  {
    value: 'lulu-rustaq',
    label: 'LuLu Hypermarket - Rustaq',
    description: 'Rustaq',
  },
  {
  ...
  {
    value: 'lulu-al-bandar',
    label: 'LuLu Hypermarket - Al Bandar',
    description: 'Al Bandar',
  },
  {
    value: 'lulu-mabelah',
    label: 'LuLu Hypermarket - Mabelah',
    description: 'Mabelah',
  },
  {
    value: 'lulu-darsait',
    label: 'LuLu Hypermarket - Darsait',
    description: 'Darsait',
  },
  {
    value: 'lulu-al-khoudh',
    label: 'LuLu Hypermarket - Al Khoudh',
    description: 'Al Khoudh',
  },
  {
    value: 'lulu-wadi-kabir',
    label: 'LuLu Hypermarket - Wadi Kabir',
    description: 'Wadi Kabir',
  },

  // HyperMax Locations
  {
    value: 'hypermax-mall-of-oman',
    label: 'HyperMax - Mall of Oman',
    description: 'Mall of Oman',
  },
  {
  ...
  {
    value: 'hypermax-salalah',
    label: 'HyperMax - Salalah',
    description: 'Salalah',
  },
  ...
  {
    value: 'hypermax-al-buraimi',
    label: 'HyperMax - Al Buraimi',
    description: 'Al Buraimi',
  },
  ...
  {
    value: 'al-khuwair-muscat',
    label: 'Al Khuwair, Muscat',
    description: 'Al Khuwair, Muscat',
  },
  {
  ...
  },
  {
    value: 'field-work',
    label: 'Field Work',
    description: 'Mobile/field-based work',
  },
...
> {
  ...
  CONTRACT_TYPES.forEach(contractType => {
    const category =
      (contractType as unknown as { category?: string }).category || 'Other';
    if (!categories[category]) {
      categories[category] = [];
    }
    categories[category].push(
      contractType as unknown as {
        value: string;
        label: string;
        category?: string;
      }
...
export function getMakecomContractTypes(): Array<{
  ...
  return CONTRACT_TYPES.filter(type =>
    isMakecomEnabled(type.value)
  ) as unknown as Array<{
    value: string;
    label: string;
    category?: string;
