// Corrected import script for promoters matching actual database schema
...
async function importPromotersCorrected() {
  console.log('=== Corrected Import: Promoters with Actual Schema ===');
  ...
  try {
    ...
    fs.createReadStream(csvFilePath)
      ...
      .on('data', (row) => {
        ...
        // Map to actual database schema (no passport_number field)
        const promoter = {
          name_en: row['Name (EN)'] || '',
          name_ar: row['Name (AR)'] || '',
