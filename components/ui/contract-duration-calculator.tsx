...
export function ContractDurationCalculator({
  ...
  const getDurationStatus = () => {
    ...
    if (isPastStart)
      return { status: "warning", message: "Start date is in the past", icon: AlertTriangle }
    if (isShortDuration)
      return { status: "warning", message: "Very short contract duration", icon: AlertTriangle }
    if (isLongDuration)
      return { status: "warning", message: "Very long contract duration", icon: AlertTriangle }
