        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div className='p-4 border rounded-lg'>
            ...
            <div className='space-y-2 text-sm'>
              <div
                className={`flex items-center gap-2 ${roleInfo.canDoAdmin ? 'text-green-600' : 'text-gray-400'}`}
              >
          ...
          <div className='p-4 border rounded-lg'>
            ...
            <div className='space-y-2 text-sm'>
              <div
                className={`flex items-center gap-2 ${roleInfo.canDoUser ? 'text-green-600' : 'text-gray-400'}`}
              >
