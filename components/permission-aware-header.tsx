        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            {hasPermission("contracts.view") && (
              <Link href="/contracts" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                Contracts
              </Link>
            )}
            ...
            {hasPermission("workflow.view") && (
              <Link href="/workflow" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                Workflow
              </Link>
            )}
            
            {hasPermission("crm.view") && (
              <Link href="/crm" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                CRM
              </Link>
            )}
          </nav>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-gray-700 capitalize">{userRole || 'user'}</span>
            </div>
