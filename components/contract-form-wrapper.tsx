        ...
        <Card className="mx-auto max-w-2xl">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              The contract form encountered an error and couldn't render properly. 
              This might be due to data loading issues or component conflicts.
            </p>
    ...
    <CardContent className="p-8">
      <div className="flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Please wait while we load the contract generation form...</p>
        </div>
      </div>
    </CardContent>
  </Card>
      ...
      default: () => (
        <Card className="mx-auto max-w-2xl">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Unable to load the contract form. This might be due to authentication or network issues.
            </p>
            <div className="flex justify-center gap-4">
