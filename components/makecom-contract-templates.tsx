      ...
      <div className='space-y-4 text-center'>
        ...
        >
          ...
          <p className='mt-2 text-lg text-muted-foreground'>
            Manage and configure automated contract generation with Make.com
            integration
          </p>
        </motion.div>
              ...
              <div className='text-center text-muted-foreground'>
                {loading ? (
                  ...
                  <div>
                    ...
                    <p>
                      Make.com contract templates are not available. Please
                  ...
                  <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                    <div>
                      ...
                      <div className='space-y-1'>
                        {selectedContractType &&
                        selectedContractType.requiredFields ? (
                          selectedContractType.requiredFields.map(
                            (field, idx) => (
                              <div
                                key={idx}
                    ...
                    <CardContent className='space-y-4'>
                      ...
                      <div>
                        ...
                        <div className='mt-2 space-y-2'>
                          {templateConfig &&
                          templateConfig.templatePlaceholders ? (
                            Object.entries(
                              templateConfig.templatePlaceholders
                            ).map(([key, description]) => (
                              <div
                      ...
                      <div>
                        ...
                        <div className='mt-2 flex flex-wrap gap-1'>
                          ...
                          templateConfig.makecomModuleConfig
                            ...
                            templateConfig.makecomModuleConfig.webhookTriggerFields.map(
                              field => (
                                <Badge
                                  key={field}
                                  variant='outline'
              ...
              <Card>
                <CardHeader className='flex flex-row items-center justify-between'>
                  <div>
                    ...
                    <CardDescription>
                      Generated Make.com scenario blueprint for automated
                      contract processing
                    </CardDescription>
                  </div>
                  ...
                  {blueprint ? (
                    <div className='space-y-4'>
                      <Alert>
                        ...
                        <AlertDescription>
                          Blueprint generated successfully! Import this JSON
                          file into Make.com to create the automated workflow.
                        </AlertDescription>
                      </Alert>
              ...
              <Card>
                ...
                <CardContent>
                  <Alert>
                    ...
                    <AlertDescription>
                      Testing functionality will be available once you have
                      configured your Make.com webhook URLs in the environment
                      variables.
                    </AlertDescription>
                  </Alert>
