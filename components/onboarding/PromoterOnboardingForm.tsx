...
export default function PromoterOnboardingForm() {
  ...
  const completionPercentage = Math.round(
    (ONBOARDING_STEPS.filter((step) => step.status === "completed").length /
      ...
      <CardContent className="space-y-6">
        {[
          ...
          },
          {
            ...
            label: "ID Card",
            required: true,
            description: "Upload a clear copy of your ID card",
          },
          {
            key: "passport",
            label: "Passport",
            required: false,
            description: "Upload your passport (if available)",
          },
          {
            key: "profilePicture",
            ...
            <div className="rounded-lg border-2 border-dashed border-gray-300 p-6 text-center">
              {formData.documents[key as keyof OnboardingData["documents"]] ? (
                ...
                <div className="space-y-2">
                  ...
                  <Button variant="outline" onClick={() => fileInputRefs.current[key]?.click()}>
  ...
  const SkillsStep = () => (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Tell us about your skills and relevant work experience.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div>
          <Label>Skills</Label>
            ...
            {[
              ...
              <div key={key} className="flex items-center space-x-3">
                <Checkbox
                  id={key}
                  checked={
                    formData.availability[key as keyof typeof formData.availability] as boolean
                  }
                  onCheckedChange={(checked) =>
                    setFormData((prev) => ({
                      ...prev,
        ...
        <Tabs defaultValue="personal" className="w-full">
          ...
          <TabsContent value="skills" className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">{formData.experience}</p>
            </div>
          </TabsContent>
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 p-6">
      <div>
        ...
        <p className="text-muted-foreground">Complete your application to become a promoter</p>
      </div>
