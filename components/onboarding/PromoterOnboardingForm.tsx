...
const REQUIREMENTS_CHECKLIST = [
  ...
  {
    id: 'legal_work',
    label: 'I have legal right to work in this country',
    required: true,
  },
  { id: 'no_criminal', label: 'I have no criminal record', required: true },
  {
    id: 'communication',
    label: 'I have good communication skills',
    required: true,
  },
  ...
  {
    id: 'experience',
    label: 'I have previous promotion experience',
    required: false,
  },
];
...
export default function PromoterOnboardingForm() {
  ...
  const handleFileUpload = (
    field: keyof OnboardingData['documents'],
    file: File
  ) => {
    setFormData(prev => ({
      ...prev,
              ...
              {formData.documents[key as keyof OnboardingData['documents']] ? (
                <div className='space-y-2'>
                  ...
                  <p className='text-sm font-medium'>
                    {
                      formData.documents[
                        key as keyof OnboardingData['documents']
                      ]?.name
                    }
                  </p>
  ...
  const RequirementsStep = () => (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Please confirm that you meet all the required criteria to become a
          promoter.
        </CardDescription>
      </CardHeader>
      <CardContent>
                ...
                <Checkbox
                  ...
                  checked={
                    formData.availability[
                      key as keyof typeof formData.availability
                    ] as boolean
                  }
                  onCheckedChange={checked =>
                    setFormData(prev => ({
            ...
            <div className='space-y-2'>
              {REQUIREMENTS_CHECKLIST.map(requirement => (
                ...
                >
                  ...
                  <Badge
                    variant={
                      formData.requirements[requirement.id]
                        ? 'default'
                        : 'secondary'
                    }
                  >
