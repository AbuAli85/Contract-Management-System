...
import { Home, BarChart3, FilePlus, UserCheck, User, Bell, Shield, Moon, Sun, Building2, Briefcase, FileCheck, FileX, FileSearch, FileEdit, TrendingUp, Menu, Download, HelpCircle, Users, Mail, MessageSquare, UserCog, Activity, Upload, Database, Settings, Package2, AlertTriangle, ClipboardList, ChevronUp, ChevronDown } from 'lucide-react'
