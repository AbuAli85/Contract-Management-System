...
import { Building2, Globe, Mail, Phone, MapPin, Save, RotateCcw } from 'lucide-react'
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  This will be used in URLs: /companies/{formData.slug || 'your-slug'}
                </p>
              </div>
            </div>
          ...
          <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
            <h4 className="font-medium text-blue-900 mb-2">Conflict Resolution Strategy</h4>
