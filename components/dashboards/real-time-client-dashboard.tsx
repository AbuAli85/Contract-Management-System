...
export function RealTimeClientDashboard({ clientId }: RealTimeClientDashboardProps) {
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">${stats?.total_spent.toLocaleString() || '0'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{stats?.saved_providers || 0}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{stats?.avg_project_rating || '0'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-600 mb-2">
                    {Math.round(((stats?.completed_projects || 0) / Math.max(stats?.active_projects || 1 + stats?.completed_projects || 0, 1)) * 100)}%
                  </div>
                  <p className="text-sm text-gray-600">Success Rate</p>
                  <Progress 
                    value={Math.round(((stats?.completed_projects || 0) / Math.max(stats?.active_projects || 1 + stats?.completed_projects || 0, 1)) * 100)} 
                    className="mt-2" 
                  />
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects
              ...
              .filter(project => 
                ...
                project.provider.name.toLowerCase().includes(searchTerm.toLowerCase())
              )
              .map((project) => (
              <Card key={project.id} className="hover:shadow-lg transition-shadow">
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    ...
                    <span className="text-sm text-gray-500">{getServiceTypeLabel(project.service_type)}</span>
                  </div>
        ...
        <TabsContent value="services" className="space-y-6">
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Discover New Services</h3>
              <p className="text-gray-600 mb-4">
                Browse our marketplace to find the perfect service provider for your next project
              </p>
              <Link href="/marketplace/services">
                <Button>
                  <Search className="h-4 w-4 mr-2" />
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium">{stats?.avg_project_rating || '0'}/5</span>
                    </div>
                    <Progress value={(stats?.avg_project_rating || 0) * 20} className="h-2" />
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-4">Spending Analysis</h4>
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-purple-50 rounded-lg">
                      <div className="text-2xl font-bold text-purple-600">
                        ${Math.round((stats?.total_spent || 0) / Math.max(stats?.completed_projects || 1, 1)).toLocaleString()}
                      </div>
                      <p className="text-sm text-purple-700">Average per Project</p>
                    </div>
                  </div>
                </div>
              </div>
