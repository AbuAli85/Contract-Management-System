...
export function UnifiedBusinessDashboard() {
  const [selectedView, setSelectedView] = useState<'overview' | 'clients' | 'providers' | 'relationships'>('overview')
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case 'provider': return Factory
      case 'relationship': return Heart
      case 'contract': return Award
      ...
      <div className="space-y-6 p-6">
        ...
        <Tabs value={selectedView} onValueChange={(v) => setSelectedView(v as any)} className="space-y-6">
          <TabsList className="grid w-full grid-cols-4 h-14">
            ...
            <TabsTrigger value="clients" className="flex items-center gap-2 h-full">
              <Users className="h-4 w-4" />
              Clients
            </TabsTrigger>
            <TabsTrigger value="providers" className="flex items-center gap-2 h-full">
              <Factory className="h-4 w-4" />
              Providers
            </TabsTrigger>
            <TabsTrigger value="relationships" className="flex items-center gap-2 h-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                <Card className="relative overflow-hidden">
                  ...
                  <CardContent>
                    <div className="text-3xl font-bold">{systemStats.total_clients}</div>
              ...
              >
                <Card className="relative overflow-hidden">
                  ...
                  <CardContent>
                    <div className="text-3xl font-bold">{systemStats.total_providers}</div>
                    <div className="flex items-center gap-1 text-xs text-muted-foreground">
                      <TrendingUp className="h-3 w-3 text-green-500" />
              ...
              >
                <Card className="relative overflow-hidden">
                  ...
                  <CardContent>
                    <div className="text-3xl font-bold">{systemStats.active_relationships}</div>
                    <div className="flex items-center gap-1 text-xs text-muted-foreground">
                      <TrendingUp className="h-3 w-3 text-green-500" />
              ...
              >
                <Card className="relative overflow-hidden">
                  ...
                  <CardContent>
                    <div className="text-3xl font-bold">${(systemStats.total_value / 1000).toFixed(0)}K</div>
                    <div className="flex items-center gap-1 text-xs text-muted-foreground">
                      <TrendingUp className="h-3 w-3 text-green-500" />
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-bold text-green-600">{systemStats.system_health}%</span>
                      </div>
                      <Progress value={systemStats.system_health} className="h-2" />
                    </div>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium">Client Satisfaction</span>
                        <span className="text-sm font-bold text-blue-600">{systemStats.satisfaction_avg}/5.0</span>
                      </div>
                      <Progress value={(systemStats.satisfaction_avg / 5) * 100} className="h-2" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-4 border-t">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs text-muted-foreground">Active Promoters</div>
                    </div>
                    <div className="text-center">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <div>
                      <p className="text-sm font-medium text-green-800">Excellent Growth</p>
                      <p className="text-xs text-green-600">System showing strong expansion</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                    <Target className="h-4 w-4 text-blue-600 mt-0.5" />
                    <div>
                      <p className="text-sm font-medium text-blue-800">Optimization Ready</p>
                      <p className="text-xs text-blue-600">Ready for scaling initiatives</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-yellow-600">{systemStats.pending_actions} items need attention</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
