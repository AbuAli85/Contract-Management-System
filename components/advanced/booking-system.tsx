...
export function BookingSystem() {
  ...
  const handleCreateBooking = async () => {
    try {
      // Validate form
      if (!bookingForm.resource_id || !bookingForm.title || !bookingForm.start_time || !bookingForm.end_time) {
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-lg">Loading booking system...</p>
        </div>
      </div>
    )
  }
            ...
            <DialogContent className="max-w-md">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Select value={bookingForm.resource_id} onValueChange={(value) => 
        ...
        <TabsContent value="calendar" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>All bookings for the selected date</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  {filteredBookings.map((booking) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mb-1">{booking.resource_name}</p>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        ...
                        {resource.hourly_rate && (
                          <div className="flex justify-between text-sm">
                            <span>Rate:</span>
                            <span className="font-medium">${resource.hourly_rate}/hour</span>
                          </div>
                        )}
                        ...
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium">
                            {resource.availability_hours.start} - {resource.availability_hours.end}
                          </span>
                        </div>
                        ...
                        <Button 
                          ...
                          onClick={() => {
                            setBookingForm(prev => ({ ...prev, resource_id: resource.id }))
        ...
        <TabsContent value="bookings" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>All your current and past bookings</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div key={booking.id} className="flex items-center gap-4 p-4 border rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-xs text-muted-foreground">
                        ...
                        {booking.total_cost && <span>${booking.total_cost}</span>}
                      </div>
                    </div>
