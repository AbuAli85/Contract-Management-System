...
export function AdvancedWorkflowEngine() {
  ...
  const getStepIcon = (type: string) => {
    switch (type) {
      ...
      case 'signature': return <FileText className="h-4 w-4" />
                ...
                <CardContent>
                  <div className="grid gap-4 md:grid-cols-4">
                    ...
                    <div>
                      ...
                      <div className="text-2xl font-bold">{workflow.metrics.averageCompletionTime}h</div>
                    </div>
                    <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm">
                          {Object.keys(instance.variables).length} set
                        </div>
                      </div>
                    </div>
