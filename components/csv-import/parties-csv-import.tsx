  ...
  },
  {
    ...
    validator: value => {
      ...
      return valid.includes(value.toLowerCase())
        ? null
        : 'Must be: Employer, Client, Vendor, or Partner';
    },
    transformer: value => {
...
export function PartiesCSVImport() {
  ...
  const [parseResult, setParseResult] =
    useState<CSVParseResult<PartyCSVRow> | null>(null);
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const result = validateAndTransformCSV<PartyCSVRow>(
        content,
        PARTY_COLUMNS
      );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Upload a CSV file to bulk import parties (employers, clients, vendors,
          partners).
        </CardDescription>
      </CardHeader>
                ...
                >
                  {isImporting ? (
                    ...
                    <>
                      ...
                      Import {parseResult.data.length} Part
                      {parseResult.data.length !== 1 ? 'ies' : 'y'}
                    </>
                  )}
                </Button>
