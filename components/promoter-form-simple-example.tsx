...
export function PromoterFormSimpleExample() {
  ...
  const handleSubmit = async (data: PromoterFormData) => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : 'Failed to create promoter');
    ...
    <div className="container max-w-5xl mx-auto py-8">
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            This example demonstrates the basic usage of the comprehensive promoter form component.
            The form includes all required fields from the database schema with proper validation.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2 text-sm">
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              ...
              <li>Business rule validation (e.g., ID expiry must be in future)</li>
