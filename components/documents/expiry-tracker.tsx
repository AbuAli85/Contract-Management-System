...
import { DocumentService, type CompanyDocument, type DocumentExpiryStatus } from '@/lib/document-service'
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (companyId) {
        ...
        documentsResult = await DocumentService.getDocumentsByCompany(companyId)
        ...
        throw new Error('Either companyId or showAllCompanies must be provided')
      }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Card className="border-orange-200 bg-orange-50">
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-orange-700">{statistics.expiringSoon}</div>
        ...
        <Card className="border-yellow-200 bg-yellow-50">
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-yellow-700">{statistics.expiring}</div>
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-green-700">{statistics.valid}</div>
        ...
        <Card className="border-gray-200 bg-gray-50">
          <CardContent className="p-4">
            <div className="text-2xl font-bold text-gray-700">{statistics.noExpiry}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: CompanyDocument['document_type'] | 'all') => 
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) => {
                  const [sortBy, sortOrder] = value.split('-') as [ExpiryFilter['sortBy'], ExpiryFilter['sortOrder']]
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="expiry_date-asc">Expiry Date (Earliest)</SelectItem>
                  <SelectItem value="expiry_date-desc">Expiry Date (Latest)</SelectItem>
                  <SelectItem value="document_type-asc">Document Type (A-Z)</SelectItem>
                  <SelectItem value="document_type-desc">Document Type (Z-A)</SelectItem>
          ...
          {filteredDocuments.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">
                {filters.status !== 'all' || filters.documentType !== 'all' || filters.searchQuery
            ...
            <div className="space-y-4">
              {filteredDocuments.map((document) => {
                const expiryStatus = DocumentService.getExpiryStatus(document.expiry_date || null)
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                          ...
                          {document.issuing_authority && (
                            <div>
                              ...
                              <p className="text-muted-foreground">{document.issuing_authority}</p>
                            </div>
                          )}
        ...
        <DialogContent>
          ...
          {selectedDocument && (
            <div className="space-y-4">
              ...
              <div>
                <Label>Document Type</Label>
                <Input value={DOCUMENT_TYPE_LABELS[selectedDocument.document_type]} disabled />
              </div>
              ...
              <div>
                ...
                <Input
                  type="date"
                  defaultValue={selectedDocument.expiry_date?.split('T')[0] || ''}
                />
              </div>
              ...
              <div>
                ...
                <Input defaultValue={selectedDocument.issuing_authority || ''} />
              </div>
