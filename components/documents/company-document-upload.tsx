  ...
  const handleBatchUpload = () => {
    ...
    const metadata = {
      expiryDate: documentMetadata.expiryDate
        ? new Date(documentMetadata.expiryDate)
        : undefined,
    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Upload company documents such as commercial registration, licenses,
            and certificates
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className='space-y-6'>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: CompanyDocument['document_type']) =>
