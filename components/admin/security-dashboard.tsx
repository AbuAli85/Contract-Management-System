    ...
    try {
      ...
      setStats({
        ...
        blockedRequests: events.filter(
          e => e.event.includes('blocked') || e.event.includes('unauthorized')
        ).length,
        successRate:
          totalEvents > 0
    ...
    <div className='space-y-6'>
      ...
      {stats.highSeverityEvents > 0 && (
        <Alert variant='destructive'>
          ...
          <AlertDescription>
            {stats.highSeverityEvents} high-severity security events detected.
                ...
                <div className='p-4 rounded-lg border'>
                  ...
                  <div className='space-y-2'>
                    {['critical', 'high', 'medium', 'low'].map(severity => {
                      const count = securityEvents.filter(
