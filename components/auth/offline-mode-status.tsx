            ...
            {demoUser && (
              <div className='text-xs text-orange-700 space-y-1'>
                ...
                <div className='flex items-center gap-1'>
                  ...
                  <span>
                    Since: {new Date(demoUser.loginTime).toLocaleTimeString()}
                  </span>
                </div>
              </div>
            )}
        ...
        <CardContent className='space-y-3'>
          <Alert className='border-blue-200 bg-blue-50'>
            ...
            <AlertDescription className='text-blue-800'>
              <strong>Demo Mode:</strong> The application is running with local
              demo data because the database is currently unavailable.
            </AlertDescription>
          </Alert>
          ...
          <div className='text-xs text-orange-600'>
            <p>
              <strong>Limited Functionality:</strong> Data changes are not
              persistent and some features may be restricted.
            </p>
          </div>
        </CardContent>
      </Card>
