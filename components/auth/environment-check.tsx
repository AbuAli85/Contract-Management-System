      ...
      <div className='w-full max-w-2xl bg-white rounded-lg shadow-md p-8'>
        <div className='text-center mb-6'>
          ...
          <p className='text-gray-600 text-lg'>
            Your application is missing required environment variables for
          ...
          <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
            ...
            <div className='space-y-2 text-sm'>
              <div className='flex items-center space-x-2'>
                <span
                  className={`w-3 h-3 rounded-full ${supabaseUrl ? 'bg-green-500' : 'bg-red-500'}`}
                ></span>
              ...
              <div className='flex items-center space-x-2'>
                <span
                  className={`w-3 h-3 rounded-full ${supabaseAnonKey ? 'bg-green-500' : 'bg-red-500'}`}
                ></span>
                <code className='bg-gray-100 px-2 py-1 rounded'>
            ...
            (window.location.hostname.includes('vercel.app') ||
              ...
              <>
                <p className='text-sm text-blue-700 mb-3'>
                  <strong>This is a production environment.</strong> Environment
                  variables must be set in your hosting platform (Vercel).
                </p>
                ...
                <p className='text-xs text-blue-600 mt-2'>
                  <strong>Important:</strong> After adding variables, you MUST
          ...
          <div className='bg-green-50 border border-green-200 rounded-lg p-4'>
            ...
            (window.location.hostname.includes('vercel.app') ||
              ...
              <ul className='list-disc list-inside space-y-1 text-sm text-green-700'>
                ...
                <li>
                  <strong>Redeploy your application</strong> (Deployments →
                  Latest → Redeploy)
                </li>
