...
export default function CaptchaBypass({ onBypass, onCancel }: CaptchaBypassProps) {
    ...
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent className="space-y-4">
        <Alert>
          ...
          <AlertDescription>
            <strong>Development Mode:</strong> CAPTCHA verification is enabled in your Supabase project. 
            This is a security feature that requires human verification.
          </AlertDescription>
        </Alert>
        ...
        <div className="text-xs text-gray-500 text-center">
          <p>
            <strong>Note:</strong> This bypass is only for development. 
            In production, proper CAPTCHA configuration is required.
          </p>
        </div>
      </CardContent>
    </Card>
