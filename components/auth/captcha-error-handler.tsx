...
export default function CaptchaErrorHandler({ error, onRetry, onBypass }: CaptchaErrorHandlerProps) {
  const [showBypass, setShowBypass] = useState(false);

  const isCaptchaError = error.toLowerCase().includes('captcha') || 
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="p-4">
              <h4 className="font-medium text-gray-900 mb-2">Option 1: Disable CAPTCHA (Recommended for Development)</h4>
            ...
            <Card className="p-4">
              <h4 className="font-medium text-gray-900 mb-2">Option 2: Configure CAPTCHA</h4>
              <ol className="text-sm text-gray-600 space-y-1 list-decimal list-inside mb-3">
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => window.open('https://supabase.com/docs/guides/auth/captcha', '_blank')}
                className="w-full"
              >
                <ExternalLink className="mr-2 h-4 w-4" />
                View Documentation
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              onClick={() => window.open('https://supabase.com/dashboard/project/_/auth/settings', '_blank')}
              variant="outline"
              size="sm"
            >
              <ExternalLink className="mr-2 h-4 w-4" />
