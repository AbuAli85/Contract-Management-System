          ...
          {availableProviders.map((provider) => {
            ...
            return (
              <Button
                key={provider}
                variant="outline"
                className={`w-full h-12 ${config.bgColor} ${config.color} justify-start gap-3`}
...
export function SocialLoginSuccess({ 
  provider, 
  user 
}: { 
  provider: string
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Successfully signed in with {config?.name || provider}
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="space-y-1 text-sm">
            ...
            <div><strong>Provider:</strong> {config?.name || provider}</div>
        ...
        <Alert>
          ...
          <AlertDescription>
            Your account is now connected to {config?.name || provider}. 
            You can use this method to sign in in the future.
          </AlertDescription>
        </Alert>
