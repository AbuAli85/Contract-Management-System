            ...
            <Dialog open={isScoreDialogOpen} onOpenChange={setIsScoreDialogOpen}>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setScoreForm({ ...scoreForm, score_type: value })}
                    >
                      <SelectTrigger>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setScoreForm({ ...scoreForm, score_value: parseInt(e.target.value) || 0 })
                        }
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setScoreForm({ ...scoreForm, max_score: parseInt(e.target.value) || 100 })
                        }
                      />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setScoreForm({ ...scoreForm, period_start: e.target.value })
                        }
                      />
                    </div>
                    <div>
                ...
                <DialogFooter>
                  ...
                  <Button onClick={handleScoreSubmit}>{editingItem ? "Update" : "Add"}</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          </div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <div className="text-right">
                          ...
                          <Progress
                            value={(score.score_value / (score.max_score || 100)) * 100}
                            className="w-20"
                          />
                        </div>
            ...
            <Dialog open={isBadgeDialogOpen} onOpenChange={setIsBadgeDialogOpen}>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setBadgeForm({ ...badgeForm, badge_description: e.target.value })
                      }
                ...
                <DialogFooter>
                  ...
                  <Button onClick={handleBadgeSubmit}>{editingItem ? "Update" : "Award"}</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          </div>
              ...
              <Card key={badge.id} className="relative">
                <CardContent className="p-6">
                  ...
                  {badge.badge_description && (
                    <p className="mb-3 text-sm text-muted-foreground">{badge.badge_description}</p>
                  )}
                  <div className="flex items-center justify-between">
            ...
            <Dialog open={isFeedbackDialogOpen} onOpenChange={setIsFeedbackDialogOpen}>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setFeedbackForm({ ...feedbackForm, feedback_text: e.target.value })
                      }
                ...
                <DialogFooter>
                  ...
                  <Button onClick={handleFeedbackSubmit}>{editingItem ? "Update" : "Add"}</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          </div>
                ...
                <div className="space-y-4">
                  {feedback.map((item) => (
                    <div key={item.id} className="rounded-lg border p-4">
                      ...
                      {item.feedback_text && <p className="mb-2 text-sm">{item.feedback_text}</p>}
                      <p className="text-xs text-muted-foreground">
