      ...
      const mockProvider: ProviderProfile = {
        ...
        portfolio: [
          {
            ...
            description:
              'Complete SEO overhaul for fashion e-commerce store resulting in 300% organic traffic increase',
            category: 'SEO',
            images: [
          ...
          },
          {
            ...
            description:
              'Multi-platform social media strategy that generated 500K impressions and 2K qualified leads',
        ...
        services: [
          ...
          },
          {
            ...
            description:
              'Professional Google Ads campaign creation and optimization',
            category: 'PPC',
            price: 499,
            duration: '3-5 days',
            rating: 4.8,
        ...
        reviews: [
          {
            ...
            rating: 5,
            comment:
              'Sarah delivered exceptional results! Our organic traffic increased by 250% within 3 months. Her SEO strategy was comprehensive and easy to understand. Highly recommended!',
          ...
          },
          {
            ...
            rating: 5,
            comment:
              'Outstanding work on our Google Ads campaign. Sarah optimized our ad spend and improved our ROAS by 180%. Professional communication throughout the project.',
          ...
          },
          {
            ...
            rating: 4,
            comment:
              'Great social media strategy! Our engagement rates doubled and we gained 5K new followers. Sarah knows her stuff and delivers on time.',
        ...
        <div className='container mx-auto px-4'>
          <div className='relative -mt-20 flex flex-col lg:flex-row items-start lg:items-end space-y-4 lg:space-y-0 lg:space-x-6'>
            <div className='relative'>
              ...
              <div
                className={`absolute -top-1 -right-1 h-6 w-6 rounded-full border-2 border-white ${
                  provider.online_status === 'online'
                    ? 'bg-green-500'
                    : provider.online_status === 'busy'
                      ? 'bg-yellow-500'
                      : 'bg-gray-400'
                }`}
              ></div>
              ...
              <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
                ...
                <div className='flex space-x-3 mt-4 lg:mt-0'>
                  <Button variant='outline' onClick={handleFollow}>
                    <Heart
                      className={`h-4 w-4 mr-2 ${isFollowing ? 'fill-red-500 text-red-500' : ''}`}
                    />
            ...
            <Card>
              ...
              <CardContent className='space-y-3'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <span className='text-sm font-medium'>
                    {provider.availability.weekly_hours}h
                  </span>
                </div>
                <div className='flex items-center justify-between'>
