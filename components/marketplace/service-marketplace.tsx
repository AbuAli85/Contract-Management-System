...
export function ServiceMarketplace() {
  ...
  const filteredServices = services.filter(service => {
    ...
    if (
      service.price_base < filters.price_range[0] ||
      service.price_base > filters.price_range[1]
    )
      return false;
    return true;
  });
          ...
          >
            <div>
              ...
              <Slider
                ...
                onValueChange={value =>
                  setFilters({
                    ...filters,
                    price_range: value as [number, number],
                  })
                }
                max={1000}
                step={50}
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  setFilters({ ...filters, rating_min: Number(value) })
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className='space-y-3'>
              ...
              <div className='flex items-center space-x-2'>
                <Switch
                  ...
                  onCheckedChange={checked =>
                    setFilters({ ...filters, featured_only: checked })
                  }
                />
      ...
      <div className='flex items-center justify-between mb-6'>
        ...
        {filteredServices.length > 0 && !loading && (
          <div className='text-sm text-gray-500'>
            Showing results for{' '}
            {searchTerm ? `"${searchTerm}"` : 'all services'}
          </div>
        )}
      </div>
