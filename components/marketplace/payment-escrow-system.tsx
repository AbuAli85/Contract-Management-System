...
export function PaymentEscrowSystem({
  ...
  const handleRequestRefund = async (transactionId: string, reason: string) => {
    try {
      ...
      toast.success(
        'Refund request submitted. Processing within 3-5 business days.'
      );
      ...
      <CardContent className='p-6'>
          ...
          <div className='flex items-center space-x-3'>
            <Avatar>
              <AvatarImage
                src={
                  userRole === 'client'
                    ? transaction.provider.avatar_url
                    : transaction.client.avatar_url
                }
              />
              <AvatarFallback>
                {userRole === 'client'
                  ? transaction.provider.name.charAt(0)
                  : transaction.client.name.charAt(0)}
              </AvatarFallback>
            </Avatar>
            <div>
        ...
        <div className='mt-4'>
          <div className='flex items-center justify-between text-sm text-gray-600 mb-2'>
            ...
            <span>
              {
                transaction.milestones.filter(m => m.status === 'approved')
                  .length
              }{' '}
  ...
  const activeTransactions = transactions.filter(t =>
    ['pending', 'funded', 'disputed'].includes(t.status)
  );
    ...
    <div className='container mx-auto px-4 py-8'>
      ...
      <div className='mb-8'>
        ...
        <p className='text-gray-600'>
          Secure payment handling with milestone-based releases and dispute
          protection
        </p>
      </div>
        ...
        <TabsContent value='active' className='space-y-6'>
          {loading ? (
            ...
            <div className='text-center py-12'>
              ...
              <p className='text-gray-600'>
                All your transactions have been completed or are pending.
              </p>
            </div>
          )}
        </TabsContent>
                ...
                <CardContent>
                  <div className='grid grid-cols-2 gap-4'>
                    ...
                    <div>
                      ...
                      <p className='font-semibold'>
                        ${selectedTransaction.service_fee}
                      </p>
                    </div>
                    <div>
                      <p className='text-sm text-gray-600'>Processing Fee</p>
                      <p className='font-semibold'>
                        ${selectedTransaction.processing_fee}
                      </p>
                    </div>
                    <div>
                    ...
                    <div className='space-y-3'>
                      ...
                      <div>
                        ...
                        <p className='text-gray-800'>
                          {selectedTransaction.dispute.description}
                        </p>
                      </div>
                      <div className='flex items-center space-x-4'>
                        ...
                        <div>
                          ...
                          <p className='text-sm'>
                            {new Date(
                              selectedTransaction.dispute.created_at
                            ).toLocaleDateString()}
                          </p>
                        </div>
                      </div>
