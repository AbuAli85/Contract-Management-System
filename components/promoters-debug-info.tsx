  ...
  return (
    <Card className='w-full max-w-4xl mx-auto'>
      ...
      <CardContent className='space-y-4'>
        ...
        {/* Cache Warning */}
        {debugInfo.promotersCount === 0 &&
          debugInfo.apiStatus === 'success' && (
            <Alert>
              <AlertCircle className='h-4 w-4' />
              <AlertDescription>
                <strong>Data Issue Detected:</strong> API returned success but 0
                promoters.
                <br />
        ...
        <div className='space-y-2'>
          ...
          <div className='grid grid-cols-2 gap-4 text-sm'>
            <div>
              ...
              {debugInfo.networkInfo.status}
            </div>
            <div>
              <span className='text-muted-foreground'>Status Text:</span>{' '}
              {debugInfo.networkInfo.statusText}
            </div>
            <div>
            ...
            <div>
              ...
              {debugInfo.networkInfo.headers['content-type'] || 'N/A'}
            </div>
          </div>
        </div>
