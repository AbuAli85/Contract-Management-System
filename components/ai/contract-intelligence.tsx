        ...
        <TabsContent value='overview' className='space-y-4'>
          <div className='grid gap-4 md:grid-cols-3'>
            <Card>
              ...
              <CardContent>
                <div
                  className={`text-2xl font-bold ${getScoreColor(analysis.riskScore)}`}
                >
                    ...
                    <Badge
                      variant={
                        analysis.marketComparison.marketPosition === 'above'
                          ? 'default'
                          : analysis.marketComparison.marketPosition ===
                              'average'
                            ? 'secondary'
                            : 'outline'
                      }
                ...
                <div className='space-y-3'>
                  <div>
                    ...
                    <ul className='space-y-1'>
                      {analysis.marketComparison.competitiveAdvantage.map(
                        (adv, index) => (
                          <li
                            key={index}
                  ...
                  <div>
                    ...
                    <ul className='space-y-1'>
                      {analysis.marketComparison.improvementAreas.map(
                        (area, index) => (
                          <li
                            key={index}
                ...
                <div className='space-y-4'>
                  <div className='text-center'>
                    <div className='text-3xl font-bold text-green-600'>
                      {Math.round(
                        analysis.predictedOutcome.successProbability * 100
                      )}
                      %
                    </div>
                  ...
                  <div className='space-y-2'>
                    ...
                    <div className='flex justify-between'>
                      ...
                      <span className='font-medium'>
                        {analysis.predictedOutcome.timeline}
                      </span>
                    </div>
                  </div>
                </div>
