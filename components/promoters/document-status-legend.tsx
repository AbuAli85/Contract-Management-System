...
import { ShieldCheck, Clock, AlertTriangle, HelpCircle, Info } from 'lucide-react';
...
const LEGEND_ITEMS: LegendItem[] = [
  {
    ...
    icon: ShieldCheck,
    badgeClass: 'bg-gradient-to-r from-emerald-50 to-green-50 text-emerald-700 border-emerald-300',
  },
  {
    status: 'expiring',
    label: 'Expiring Soon',
    ...
    icon: Clock,
    badgeClass: 'bg-gradient-to-r from-amber-50 to-yellow-50 text-amber-700 border-amber-300',
  },
  {
    status: 'expired',
    label: 'Expired',
    ...
    icon: AlertTriangle,
    badgeClass: 'bg-gradient-to-r from-red-50 to-rose-50 text-red-700 border-red-300',
  },
  {
    status: 'missing',
    label: 'Not Provided',
    ...
    icon: HelpCircle,
    badgeClass: 'bg-gradient-to-r from-slate-50 to-gray-50 text-slate-600 border-slate-300',
  },
];
...
export function DocumentStatusLegend({ className, compact = false }: DocumentStatusLegendProps) {
  if (compact) {
    return (
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent side="bottom" className="w-80 p-4">
            <div className="space-y-2">
              <p className="font-semibold text-sm mb-3">Document Status Legend</p>
