...
export function EmployeeSelfServicePortal({
  ...
  const [employerEmployeeId, setEmployerEmployeeId] = useState<string | null>(
    null
  );
    ...
    <div className='space-y-6'>
      ...
      <div>
        ...
        <p className='text-sm text-muted-foreground mt-1'>
          Manage your tasks, targets, payroll, and documents
        </p>
      </div>
      ...
      >
        <TabsList className='grid w-full grid-cols-2 md:grid-cols-7 gap-1'>
          ...
          <TabsTrigger value='targets' className='text-xs md:text-sm'>
            Targets
          </TabsTrigger>
          <TabsTrigger value='attendance' className='text-xs md:text-sm'>
            Attendance
          </TabsTrigger>
          <TabsTrigger value='payroll' className='text-xs md:text-sm'>
            Payroll
          </TabsTrigger>
            ...
            promoterDetails.contracts.length > 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    View your employment contracts
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className='space-y-2'>
        ...
        <TabsContent value='targets' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track your performance targets and goals
              </CardDescription>
            </CardHeader>
            <CardContent>
              {targets.length > 0 ? (
                              ...
                              <div className='space-y-3 mt-3 p-3 bg-gray-50 rounded-lg'>
                                <div>
                                  ...
                                  <Input
                                    ...
                                    onChange={e =>
                                      setTargetProgress(e.target.value)
                                    }
                    ...
                    {payrollEntries.map(entry => (
                      ...
                      >
                        <div>
                          ...
                          <p className='text-sm text-muted-foreground'>
                            Period:{' '}
                            {format(parseISO(entry.period_start), 'MMM yyyy')}
                          </p>
                        </div>
        ...
        <TabsContent value='letters' className='space-y-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Employment letters, certificates, and official documents
              </CardDescription>
            </CardHeader>
            <CardContent>
              {letters.length > 0 ? (
