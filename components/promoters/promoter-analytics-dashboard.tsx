...
export function PromoterAnalyticsDashboard({
  ...
  const [activeView, setActiveView] = useState<
    'overview' | 'performance' | 'financial' | 'trends'
  >('overview');
  ...
  const kpis = useMemo((): KPI[] => {
    ...
    return [
      ...
      },
      {
        ...
        change: 3.7,
        status:
          metrics.taskCompletion >= 90
            ? 'excellent'
            : metrics.taskCompletion >= 75
              ? 'good'
              : metrics.taskCompletion >= 60
                ? 'warning'
                : 'critical',
        ...
        status:
          metrics.customerSatisfaction >= 90
            ...
            : metrics.customerSatisfaction >= 80
              ? 'good'
              : metrics.customerSatisfaction >= 70
                ? 'warning'
                : 'critical',
      ...
      },
      {
        ...
        value:
          promoterData.contracts?.filter(c => c.status === 'active').length ||
          0,
        target: 3,
        unit: '',
        trend: 'stable',
      ...
      <div className='space-y-3'>
        {data.map((item, index) => (
          <div key={index} className='flex items-center gap-3'>
            <span className='text-xs font-medium w-8 text-gray-600'>
              {item.month}
            </span>
  ...
  const PerformanceTrendLine = ({ data }: { data: MonthlyData[] }) => {
    ...
    const points = data
      .map((item, index) => {
        ...
        const y =
          chartHeight - (item.performance / maxPerformance) * chartHeight;
        return `${x},${y}`;
      })
      .join(' ');
              ...
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                ...
                <div className='text-center p-4 bg-orange-50 rounded-lg'>
                  <div className='text-2xl font-bold text-orange-600'>
                    {formatDistanceToNow(new Date(promoterData.created_at), {
                      addSuffix: false,
                    })}
                  </div>
            ...
            <div className='flex items-start gap-3 p-3 bg-green-50 border border-green-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700 mt-1'>
                  Promoter is performing above average in all key metrics.
            ...
            <div className='flex items-start gap-3 p-3 bg-blue-50 border border-blue-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-700 mt-1'>
                  Performance has improved by 12% this month. Continue current
            ...
            <div className='flex items-start gap-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-yellow-700 mt-1'>
                  ID card expires in 15 days. Schedule renewal to maintain
                  compliance.
                </p>
              </div>
            </div>
