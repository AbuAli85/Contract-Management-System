      ...
      >
        <CardContent className='p-5'>
          ...
          <div className='flex items-start justify-between mb-4'>
            ...
            <Badge
              className={`${getStatusColor(contract.status)} flex items-center gap-1 px-3 py-1`}
            >
          ...
          <div className='space-y-2'>
            {contract.approved_at && (
              <div className='flex items-center gap-2 text-xs text-gray-500'>
                ...
                <span>
                  Approved:{' '}
                  {format(new Date(contract.approved_at), 'MMM dd, yyyy')}
                </span>
              </div>
            )}
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-6'>
            <div className='text-center p-4 bg-green-50 rounded-lg'>
              ...
              <div className='text-xs text-green-600 mt-1'>
                {stats.activeRate.toFixed(1)}% of total
              </div>
            </div>
            ...
            {stats.expiringSoon > 0 && (
              <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4'>
                <div className='flex items-center gap-2'>
                  ...
                  <span className='font-medium text-yellow-800'>
                    {stats.expiringSoon} contract
                    {stats.expiringSoon !== 1 ? 's' : ''} expiring soon
                  </span>
                </div>
                <p className='text-sm text-yellow-700 mt-1'>
                  Review and renew contracts before they expire to maintain
                  continuity.
                </p>
              </div>
            )}
              ...
              <div className='bg-green-50 border border-green-200 rounded-lg p-4'>
                <div className='flex items-center gap-2'>
                  ...
                  <span className='font-medium text-green-800'>
                    {stats.recentlyCreated} new contract
                    {stats.recentlyCreated !== 1 ? 's' : ''} this week
                  </span>
                </div>
            ...
            {stats.recentlyCompleted > 0 && (
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
                <div className='flex items-center gap-2'>
                  <TrendingUp className='h-5 w-5 text-blue-600' />
                  <span className='font-medium text-blue-800'>
                    {stats.recentlyCompleted} contract
                    {stats.recentlyCompleted !== 1 ? 's' : ''} completed this
                    month
                  </span>
                </div>
            ...
            <div className='flex items-center justify-between'>
              ...
              <div className='flex items-center gap-4'>
                <div className='text-sm text-gray-500'>
                  Showing {Math.min(10, contracts.length)} of {contracts.length}{' '}
                  contracts
                </div>
                <Button
                  variant='outline'
                    ...
                    .map(contract => {
                      ...
                      const progress = isActive
                        ? Math.max(
                            ...
                            Math.min(
                              100,
                              (differenceInDays(now, startDate) / totalDays) *
                                100
                            )
                          )
                        : 0;
                        ...
                        >
                          ...
                          <TableCell>
                            <div className='flex flex-col gap-1'>
                              <Badge
                                className={`${getStatusColor(contract.status)} flex items-center gap-1 w-fit`}
                              >
                                {getStatusIcon(contract.status)}
