...
export function PromoterDocumentHealth({
  ...
  const getDocumentStatus = (expiryDate?: string) => {
    if (!expiryDate)
      return { status: 'missing', daysRemaining: 0, color: 'red' };
              ...
              <div>
                ...
                <p className='text-sm text-yellow-700 mt-1'>
                  {overallHealth.score === 0
                    ? 'Please upload missing documents to complete the profile.'
                    : overallHealth.score === 20
                      ? 'Some documents have expired and need to be renewed.'
