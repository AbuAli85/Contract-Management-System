              ...
              <div className='space-y-1.5 mt-2'>
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>ID Card {promoter.id_card_expiry_date ? `expires: ${formatDate(promoter.id_card_expiry_date)}` : 'expiry date not set'}</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className='flex items-center justify-between'>
                        <span className='text-xs text-slate-500'>Passport:</span>
                        <div className='flex items-center gap-1.5'>
                          <span className={cn(
                            'text-xs px-2 py-0.5 rounded-full border font-medium',
                    ...
                    <TooltipContent>
                      <p>Passport {promoter.passport_expiry_date ? `expires: ${formatDate(promoter.passport_expiry_date)}` : 'expiry date not set'}</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
              ...
              {completeness.percentage < 100 && (
                <div className='mt-3 pt-2 border-t border-slate-100'>
                  <div className='flex items-center justify-between mb-1'>
                    ...
                    <span className='text-xs font-medium text-amber-600'>{completeness.percentage}%</span>
                  </div>
            ...
            <DialogTitle className='flex items-center gap-2'>
              ...
              <div className='flex-1'>
                ...
                <div className='flex items-center gap-2 mt-1'>
                  <Badge variant={completeness.percentage === 100 ? 'default' : 'secondary'} className='text-xs'>
          ...
          <div className='space-y-4'>
            ...
            <div className='bg-slate-50 rounded-lg p-3 space-y-2'>
              <div className='flex items-center justify-between'>
                ...
                <span className='text-sm text-slate-900'>{lastUpdate.text}</span>
              </div>
              <div className='flex items-center justify-between'>
                <span className='text-sm font-medium text-slate-600'>Data Completeness</span>
                <span className='text-sm font-semibold text-slate-900'>{completeness.percentage}%</span>
              </div>
