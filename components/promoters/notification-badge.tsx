...
export function NotificationBadge({
  ...
  const notifications = useMemo(() => {
    ...
    return {
      ...
      total,
      displayTotal:
        total > maxDisplayCount ? `${maxDisplayCount}+` : total.toString(),
    };
      ...
      <div className='flex items-center gap-1 text-xs text-muted-foreground'>
        {notifications.critical > 0 && (
          ...
          >
            ...
            <span>
              {notifications.critical > maxDisplayCount
                ? `${maxDisplayCount}+`
        ...
        {notifications.attention > 0 && (
          ...
          >
            ...
            <span>
              {notifications.attention > maxDisplayCount
                ? `${maxDisplayCount}+`
        ...
        {notifications.expiring > 0 && (
          ...
          >
            ...
            <span>
              {notifications.expiring > maxDisplayCount
                ? `${maxDisplayCount}+`
