    ...
    return [
      {
        ...
        content:
          'Excellent performance this month. Completed all assigned tasks ahead of schedule.',
      ...
      },
      {
        ...
        content:
          'ID card renewal required by end of next month. Please schedule appointment.',
        category: 'alert',
        priority: 'high',
        is_pinned: false,
      ...
      },
      {
        ...
        content:
          'Great feedback from client on recent project. Customer satisfaction rating: 5/5.',
        ...
        <CardHeader>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <CardDescription>
                Track important information and conversations ({notes.length}{' '}
                notes)
              </CardDescription>
            </div>
            <Button
            ...
            <div className='flex flex-wrap items-center gap-3'>
              <div className='flex items-center gap-2'>
                ...
                <select
                  ...
                  onChange={e =>
                    setSelectedCategory(e.target.value as Note['category'])
                  }
              ...
              <div className='flex items-center gap-2'>
                ...
                <select
                  ...
                  onChange={e =>
                    setSelectedPriority(e.target.value as Note['priority'])
                  }
                  className='text-sm border rounded px-2 py-1'
