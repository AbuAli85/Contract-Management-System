    ...
    <Card className='max-w-4xl mx-auto bg-gradient-to-br from-green-50 via-white to-blue-50 border-2 border-green-200'>
      <CardHeader className='text-center'>
        ...
        <CardDescription className='text-lg'>
          Promoter cards in the "Assigned Promoters" section are now fully
          interactive and clickable for easy editing
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className='space-y-6'>
          ...
          <div className='space-y-3'>
            <div className='flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700'>
                  Cards now respond to clicks with visual feedback and
            ...
            <div className='flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700'>
                  Hover to reveal action dropdown with Edit, View, and Preview
                  options
                </p>
              </div>
            </div>
            ...
            <div className='flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700'>
                  Enhanced display showing ID card and passport validity status
                  with color coding
                </p>
              </div>
            </div>
            ...
            <div className='flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700'>
                  Option to view promoter details in a popup without leaving the
                  page
                </p>
              </div>
            </div>
        ...
        <div className='bg-blue-50 rounded-lg p-4 border border-blue-200'>
          ...
          <ol className='space-y-2 text-sm text-blue-700'>
            ...
            <li className='flex items-start gap-2'>
              ...
              Expand any <strong>Employer party</strong> to see assigned
              promoters
            </li>
            <li className='flex items-start gap-2'>
              <Badge variant='outline' className='mt-0.5 text-xs'>
              ...
              <strong>Click directly on any promoter card</strong> to open edit
              page
            </li>
            <li className='flex items-start gap-2'>
              <Badge variant='outline' className='mt-0.5 text-xs'>
            ...
            <li className='flex items-start gap-2'>
              ...
              Use the <strong>three-dot menu</strong> that appears on hover for
              quick actions
            </li>
          </ol>
        </div>
        ...
        <div className='bg-amber-50 rounded-lg p-4 border border-amber-200'>
          ...
          <p className='text-sm text-amber-700'>
            This enhancement is active on the <strong>Manage Parties</strong>{' '}
            page, specifically in the
            <strong>"Assigned Promoters"</strong> section that appears when you
            expand an Employer party row. All promoter cards in this section are
            now interactive and clickable for immediate editing.
          </p>
        </div>
      </CardContent>
    </Card>
