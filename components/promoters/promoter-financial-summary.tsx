    ...
    <Card className="border-2 border-blue-100">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg border border-blue-200">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-blue-700">Pending Payout</span>
        ...
        <div className="p-3 bg-purple-50 rounded-lg border border-purple-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-purple-900">Next Payout</span>
          </div>
        ...
        {showHistory && (
          <div className="space-y-2 pt-2 border-t">
            <h4 className="text-sm font-semibold text-gray-700 mb-2">Recent Payouts</h4>
            {financialData.payoutHistory.map((payout) => (
              <div key={payout.id} className="p-2 bg-gray-50 rounded border flex items-center justify-between">
                <div>
        ...
        {financialData.pendingPayout > 5000 && (
          <div className="flex items-start gap-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <div>
              <p className="text-xs font-medium text-yellow-900">High Pending Balance</p>
              <p className="text-xs text-yellow-700 mt-1">
                Consider processing early payout or reviewing contract completion status.
              </p>
            </div>
          </div>
        )}
