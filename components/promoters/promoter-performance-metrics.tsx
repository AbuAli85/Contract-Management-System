...
export function PromoterPerformanceMetrics({ metrics }: PerformanceMetricsProps) {
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className={`flex items-center gap-1 ${getTrendColor(metrics.overallScore, 75)}`}>
          ...
          <div className="mt-4 pt-4 border-t">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className={`text-sm ${getTrendColor(metrics.thisMonthTasks, metrics.lastMonthTasks)}`}>
