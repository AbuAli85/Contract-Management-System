        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-3'>
            <div className='flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700'>
                  Comprehensive dialog for managing party assignments with
            ...
            <div className='flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200'>
              ...
              <div>
                <p className='font-medium text-green-800'>
                  Enhanced Promoter Cards
                </p>
                <p className='text-sm text-green-700'>
                  Promoter cards now include "Manage Party Assignment" option in
                  the actions menu
                </p>
              </div>
            </div>
            ...
            <div className='flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700'>
                  Changes are immediately reflected in the UI with automatic
                  data refresh
                </p>
              </div>
            </div>
            ...
            <div className='flex items-center gap-3 p-3 bg-green-50 rounded-lg border border-green-200'>
              ...
              <div>
                ...
                <p className='text-sm text-green-700'>
                  Built-in form to create new parties without leaving the
                  assignment dialog
                </p>
              </div>
            </div>
        ...
        <div className='bg-blue-50 rounded-lg p-4 border border-blue-200'>
          ...
          <ol className='space-y-2 text-sm text-blue-700'>
            <li className='flex items-start gap-2'>
              ...
              Navigate to the Promoters page and switch to{' '}
            ...
            <li className='flex items-start gap-2'>
              ...
              Select <strong>"Manage Party Assignment"</strong> from the
              dropdown
            </li>
            <li className='flex items-start gap-2'>
              <Badge variant='outline' className='mt-0.5 text-xs'>
