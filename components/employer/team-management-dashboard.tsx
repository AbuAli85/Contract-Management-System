...
export function TeamManagementDashboard() {
  ...
  const calculateStats = (members: TeamMember[]) => {
    setStats({
      ...
      terminated: members.filter(m => m.employment_status === 'terminated')
        .length,
    });
  };
            ...
            <div className='flex items-center gap-4'>
              ...
              <div>
                ...
                <p className='text-gray-500 dark:text-gray-400 mt-1'>
                  Manage your team members, permissions, attendance, tasks, and
                  targets
                </p>
              </div>
            </div>
                  ...
                  <div className='flex items-start gap-6 p-6 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-xl'>
                    <Avatar className='h-24 w-24 border-4 border-white dark:border-gray-700 shadow-xl'>
                      ...
                      <AvatarFallback className='text-2xl font-bold bg-gradient-to-br from-blue-600 to-indigo-600 text-white'>
                        {getInitials(
                          selectedMember.employee?.full_name || 'NA'
                        )}
                      </AvatarFallback>
                    </Avatar>
                      ...
                      <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-3'>
                          <h2 className='text-2xl font-bold text-gray-900 dark:text-white'>
                            {selectedMember.employee?.full_name ||
                              'Unknown Employee'}
                          </h2>
                          <Badge
                            className={cn(
                      ...
                      <CardContent className='space-y-4'>
                        <div>
                          ...
                          {selectedMember.employee_code ? (
                            ...
                            <p className='text-sm font-semibold mt-1 text-gray-400 italic'>
                              Not assigned
                            </p>
                          )}
                        </div>
                        <div>
                          ...
                          <p className='text-sm font-semibold mt-1 capitalize'>
                            {selectedMember.employment_type?.replace(
                              '_',
                              ' '
                            ) || 'Full Time'}
                          </p>
                        ...
                        <div>
                          ...
                          {selectedMember.hire_date ? (
                            <p className='text-sm font-semibold mt-1'>
                              {formatDate(selectedMember.hire_date)}
                            </p>
                          ) : (
                            <p className='text-sm font-semibold mt-1 text-gray-400 italic'>
                              Not specified
