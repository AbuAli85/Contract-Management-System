...
export function AttendanceView({ employerEmployeeId }: AttendanceViewProps) {
  ...
  const formatMonthYear = (monthStr: string) => {
    ...
    return new Date(parseInt(year), parseInt(mon) - 1).toLocaleDateString(
      'en-US',
      {
        month: 'long',
        year: 'numeric',
        ...
        <CardHeader className='pb-4'>
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <CardDescription>
                Overview of attendance for {formatMonthYear(month)}
              </CardDescription>
            </div>
          </div>
        </CardHeader>
              ...
              {loading ? (
                ...
                <div className='text-center py-16'>
                  ...
                  <p className='text-gray-500 dark:text-gray-400 max-w-sm mx-auto'>
                    There are no attendance records for {formatMonthYear(month)}
                    . Records will appear here once attendance is tracked.
                  </p>
                </div>
            ...
            <TabsContent value='charts' className='mt-0 space-y-6'>
              ...
              <Card className='border-0 shadow-sm'>
                <CardHeader>
                  ...
                  <CardDescription>
                    Daily hours worked for {formatMonthYear(month)}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {chartData.length > 0 ? (
