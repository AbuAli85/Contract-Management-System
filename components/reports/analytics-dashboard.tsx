        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {formatPercentage(stats?.compliance_rate || 0)}
            </div>
            <p className='text-xs text-muted-foreground'>
              <span
                className={
                  stats?.trends.compliance_change &&
                  stats.trends.compliance_change < 0
                    ? 'text-red-600'
                    : 'text-green-600'
                }
              >
        ...
        <TabsContent value='overview' className='space-y-6'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Current status of all registered companies
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Overview of document compliance and expiry status
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='space-y-4'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Generate reports and perform common tasks
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className='flex items-center justify-between p-3 border border-red-200 rounded-lg bg-red-50'>
                    <div>
                      ...
                      <p className='text-sm text-red-700'>
                        {stats?.expired_documents} documents have expired
                      </p>
                    </div>
                  ...
                  <div className='flex items-center justify-between p-3 border border-orange-200 rounded-lg bg-orange-50'>
                    <div>
                      ...
                      <p className='text-sm text-orange-700'>
                        {stats?.expiring_soon} documents expiring within 30 days
                      </p>
                    </div>
