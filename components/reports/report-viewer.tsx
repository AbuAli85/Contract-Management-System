      ...
      <Card>
        ...
        <CardContent>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div>
              <p>
                <strong>Email:</strong> {data.company.contact_email}
              </p>
              <p>
                <strong>Phone:</strong> {data.company.phone_number}
              </p>
              <p>
                <strong>Registration Date:</strong>{' '}
                {new Date(data.company.registration_date).toLocaleDateString()}
              </p>
            </div>
            <div>
              <p>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Progress
              value={data.documents.compliance_score}
              className='mt-2'
            />
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {formatCurrency(data.contracts.total_value)}
            </div>
            <p className='text-xs text-muted-foreground'>
    ...
    <div className='space-y-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold text-green-600'>
              {data.summary.compliant_companies}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold text-red-600'>
              {data.summary.non_compliant_companies}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {formatPercentage(data.summary.compliance_rate)}
            </div>
                ...
                <TableBody>
                  {data.by_company.map((company, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        {formatPercentage(company.compliance_score)}
                      </TableCell>
                      <TableCell>
                        <Badge
                          variant={
                ...
                <TableBody>
                  {data.by_document_type.map((docType, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        {formatPercentage(docType.submission_rate)}
                      </TableCell>
                      <TableCell>
                        <Badge
                          variant={
                            docType.expired_count > 0
                              ? 'destructive'
                              : 'outline'
                          }
                        >
                      ...
                      <TableCell>
                        <Badge
                          variant={
                            docType.expiring_count > 0 ? 'secondary' : 'outline'
                          }
                        >
                  ...
                  <TableRow key={index}>
                    ...
                    <TableCell>
                      <Badge variant='destructive'>
                        {company.expired_count}
                      </Badge>
                    </TableCell>
                    <TableCell>
                      <Badge variant='secondary'>
                        {company.expiring_soon_count}
                      </Badge>
                    </TableCell>
                    <TableCell>
                      <Badge
                ...
                {data.trends.top_companies.map((company, index) => (
                  ...
                  >
                    ...
                    <Badge variant='outline'>
                      {company.activity_count} activities
                    </Badge>
                  </div>
                ))}
              </div>
    ...
    <div className='space-y-6'>
      ...
      >
        {reportType === 'company_overview' &&
          renderCompanyOverview(data as CompanyOverviewData)}
        {reportType === 'document_compliance' &&
          renderDocumentCompliance(data as DocumentComplianceData)}
        {reportType === 'expiry_analysis' &&
          renderExpiryAnalysis(data as ExpiryAnalysisData)}
        {reportType === 'activity_summary' &&
          renderActivitySummary(data as ActivitySummaryData)}
      </motion.div>
    </div>
  );
}
