...
export const DynamicComponents = {
  ...
  UserManagementDashboard: dynamic(
    () =>
      import("./user-management/user-management-dashboard").then((mod) => ({
        default: mod.UserManagementDashboard,
      })),
    {
      loading: () => (
        <div className="animate-pulse space-y-4">
...
export function GlobalPerformanceOptimizer() {
  ...
  useEffect(() => {
    const initOptimizations = async () => {
      ...
      await Promise.all([optimizeImages(), optimizeNetwork()])
