...
export function AppLayoutWithSidebar({ children }: AppLayoutWithSidebarProps) {
  ...
  const getPageTitle = () => {
    ...
    if (pathname?.includes('/dashboard/contracts'))
      return 'Contract Management';
    if (pathname?.includes('/dashboard/generate-contract'))
      return 'Generate Contract';
    if (pathname?.includes('/dashboard/makecom-templates'))
      return 'Make.com Templates';
    ...
    if (pathname?.includes('/dashboard/user-approvals'))
    ...
    if (pathname?.includes('/promoters/performance'))
      return 'Promoter Performance';
                        ...
                        <div className='hidden sm:block'>
                          <p className='text-sm text-muted-foreground'>
                            ...
                            <span className='font-medium text-foreground'>
                              ...
                              userProfile.full_name !== 'Emergency User'
                                ? userProfile.full_name
