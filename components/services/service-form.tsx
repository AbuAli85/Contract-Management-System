  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          'The service has been created and sent for approval via webhook.',
        variant: 'default',
      });
          ...
          <div className='flex items-start gap-3'>
            ...
            <div className='text-sm text-blue-800'>
              ...
              <p className='text-blue-700'>
                When you create a service, it will be sent to our approval
                system. You'll receive notifications about the approval status,
                and the service will appear in the services list once approved.
              </p>
            </div>
          </div>
        </CardContent>
