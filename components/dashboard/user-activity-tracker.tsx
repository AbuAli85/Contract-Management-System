...
export function UserActivityTracker() {
  const { activities, summary, loading, error, fetchUserActivities } = useUserActivity()
        ...
        {summary && (
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="text-center p-3 bg-blue-50 rounded-lg">
              <div className="text-2xl font-bold text-blue-600">{summary.today_activities}</div>
              <div className="text-sm text-blue-600">Today</div>
            </div>
            <div className="text-center p-3 bg-green-50 rounded-lg">
              <div className="text-2xl font-bold text-green-600">{summary.this_week_activities}</div>
