        ...
        <Card className='hover:shadow-lg transition-shadow duration-300'>
          ...
          <CardContent>
            <div className='space-y-4'>
              {Object.entries(stats.contractsByStatus).map(
                ([status, count]) => (
                  <div
                    key={status}
            ...
            <div className='space-y-4'>
              <div className='grid grid-cols-2 gap-4'>
                <div className='text-center p-4 bg-blue-50 rounded-lg'>
                  <div className='text-2xl font-bold text-blue-600'>
                    {stats.monthlyData[stats.monthlyData.length - 1]?.total ||
                      0}
                  </div>
              ...
              <div className='pt-4 border-t'>
                <p className='text-sm text-muted-foreground'>
                  ...
                  {stats.contractGrowth > 0 ? 'trending up' : 'stable'}
          ...
          <div className='grid grid-cols-1 gap-8 md:grid-cols-2'>
            ...
            <div className='space-y-4'>
              ...
              <div className='relative'>
                ...
                />
                <div
                  className='absolute inset-0 bg-gradient-to-r from-purple-400 to-purple-600 rounded-full'
            ...
            <div className='space-y-4'>
              <div className='flex items-center justify-between'>
                ...
                <span className='text-lg font-bold text-green-600'>
                  {stats.totalPromoters > 0
                    ? Math.round(
                        (stats.activePromoters / stats.totalPromoters) * 100
                      )
                    : 0}
                  %
                </span>
              ...
              <div className='relative'>
                ...
                <div
                  ...
                  style={{
                    width: `${stats.totalPromoters > 0 ? (stats.activePromoters / stats.totalPromoters) * 100 : 0}%`,
                  }}
                />
              </div>
              <p className='text-sm text-slate-500 font-medium'>
