    ...
    <section className='grid gap-6 md:grid-cols-2'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Distribution of contracts by their current status. / توزيع العقود
            حسب حالتها الراهنة.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            Monthly Contracts & Revenue / العقود والإيرادات الشهرية
          </CardTitle>
          <CardDescription>
            Track contract volume and revenue generation over time. / تتبع حجم
            العقود وتوليد الإيرادات بمرور الوقت.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <ChartContainer config={chartConfig} className='h-[300px] w-full'>
