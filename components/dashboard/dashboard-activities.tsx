        ...
        {!activities || activities.length === 0 ? (
          <div className='flex flex-col items-center justify-center py-16 text-center'>
            ...
            <p className='text-slate-600 max-w-md leading-relaxed mb-8 font-medium'>
              Activities will appear here as they happen. Create a contract or
              add a promoter to get started and see your system come to life.
            </p>
            <div className='flex flex-col sm:flex-row gap-3'>
              ...
              <Link href='/manage-promoters/new'>
                <Button
                  variant='outline'
                  className='border-purple-200 text-purple-700 hover:bg-purple-50 hover:border-purple-300 shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-105'
                >
