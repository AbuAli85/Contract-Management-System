...
export default function AuditLogs() {
  ...
  const fetchAuditLogs = async () => {
    ...
    try {
      ...
      const transformedLogs: AuditLogItem[] = (data.data || []).map(
        (log: any) => ({
          id: log.id.toString(),
      ...
      log =>
        ...
        (log.details &&
          ...
          JSON.stringify(log.details)
            .toLowerCase()
            .includes(searchTerm.toLowerCase())) // Search in stringified JSON
    );
  }, [logs, searchTerm]);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Track system activities and user actions. / تتبع أنشطة النظام وإجراءات
          المستخدم.
        </CardDescription>
      </CardHeader>
      <CardContent>
