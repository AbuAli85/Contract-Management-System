          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center space-x-2">
                ...
                <div className={`h-2 w-2 rounded-full ${getPriorityColor(workflow.priority)}`} />
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                {workflow.status === "active" && (
                  <Button variant="ghost" size="sm" onClick={() => onPauseWorkflow(workflow.id)}>
                    <Pause className="h-4 w-4" />
                  </Button>
                )}
                {workflow.status === "paused" && (
                  <Button variant="ghost" size="sm" onClick={() => onResumeWorkflow(workflow.id)}>
                    <Play className="h-4 w-4" />
                  </Button>
                )}
                <Button variant="ghost" size="sm" onClick={() => onCancelWorkflow(workflow.id)}>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className={`h-3 w-3 rounded-full ${getPriorityColor(workflow.priority)}`} />
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">
              {
                workflows.filter(
                  (w) => w.deadline && new Date(w.deadline) < new Date() && w.status === "active",
                ).length
              }
            </div>
          </CardContent>
