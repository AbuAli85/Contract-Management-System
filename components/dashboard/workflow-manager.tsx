...
export function WorkflowManager({
  ...
  const [selectedWorkflow, setSelectedWorkflow] =
    useState<ContractWorkflow | null>(null);
          ...
          <div className='flex items-start justify-between'>
            <div className='flex-1'>
              <div className='flex items-center space-x-2'>
                ...
                <div
                  className={`h-2 w-2 rounded-full ${getPriorityColor(workflow.priority)}`}
                />
        ...
        <CardContent>
          <div className='space-y-4'>
              ...
              <div className='rounded-lg bg-muted p-3'>
                <div className='flex items-center justify-between'>
                  ...
                  <div className='flex items-center space-x-2'>
                    ...
                    <Badge
                      variant='outline'
                      className={getStatusColor(currentStep.status)}
                    >
                      {currentStep.status}
                    </Badge>
                  </div>
            ...
            <div className='flex items-center justify-between text-sm text-muted-foreground'>
              ...
              {workflow.deadline && (
                <div
                  className={`flex items-center space-x-1 ${isOverdue ? 'text-red-500' : ''}`}
                >
    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-start justify-between'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          <div
            className={`h-3 w-3 rounded-full ${getPriorityColor(workflow.priority)}`}
          />
        </div>
      </div>
                  ...
                  {step.status === 'in_progress' && (
                    <div className='mt-3 flex items-center space-x-2'>
                      <Button
                        size='sm'
                        onClick={() =>
                          onApproveStep(workflow.id, step.id, actionNotes)
                        }
                      >
                      ...
                      <Button
                        ...
                        size='sm'
                        onClick={() =>
                          onRejectStep(workflow.id, step.id, actionNotes)
                        }
                      >
                      ...
                      <Button
                        ...
                        size='sm'
                        onClick={() =>
                          onSkipStep(workflow.id, step.id, actionNotes)
                        }
                      >
    ...
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Manage contract approval workflows
          </p>
        </div>
        <div className='flex items-center space-x-2'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {
                workflows.filter(w =>
                  w.steps.some(s => s.status === 'in_progress')
                ).length
              }
            </div>
          </CardContent>
