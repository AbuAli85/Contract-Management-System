...
export function PerformanceMonitor() {
  ...
  return (
    <Card className="fixed bottom-4 right-4 z-50 w-80 border-l-4 border-l-blue-500 shadow-lg">
      ...
      {!isMinimized && (
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-mono text-sm">{metrics.apiResponseTime}ms</span>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-mono text-sm">{metrics.cacheHitRate}%</span>
          </div>
