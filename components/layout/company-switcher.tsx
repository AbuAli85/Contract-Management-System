...
function CreateCompanyDialog({
  ...
  setNewCompany: React.Dispatch<React.SetStateAction<{ name: string; description: string }>>;
  onSubmit: () => void;
  creating: boolean;
}) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new company to your account. You can manage multiple companies from a single login.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          ...
          <Button onClick={onSubmit} disabled={creating || !newCompany.name.trim()}>
