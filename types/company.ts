...
export const companyProfileSchema = z.object({
  ...
  commercial_registration: z.string().min(1, "Commercial Registration number is required"),
...
export interface CompanyDocument {
  id: string
  company_id: string
  document_type: 'commercial_registration' | 'business_license' | 'tax_certificate' | 'logo' | 'other'
  file_name: string
  file_url: string
  file_size: number
  mime_type: string
