...
function prepareTemplateData(contract: any): Record<string, any> {
  return {
    ...
    contract_start_date: contract.contract_start_date ? new Date(contract.contract_start_date).toLocaleDateString('en-GB') : '',
    contract_end_date: contract.contract_end_date ? new Date(contract.contract_end_date).toLocaleDateString('en-GB') : '',
...
function validateTemplateData(data: Record<string, any>): { isValid: boolean; errors: string[]; missingFields: string[] } {
  const errors: string[] = []
...
async function exportWithPuppeteer(contract: any, templateData: any, options: any): Promise<ExportSuccess> {
...
async function exportWithMakecom(contract: any, templateData: any, options: any): Promise<ExportSuccess> {
...
async function exportWithGoogleDocs(contract: any, templateData: any, options: any): Promise<ExportSuccess> {
