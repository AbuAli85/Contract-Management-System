...
-- These tables support product/service information and location data
...
CREATE INDEX IF NOT EXISTS idx_locations_city_en ON locations(city_en);
CREATE INDEX IF NOT EXISTS idx_locations_city_ar ON locations(city_ar);
CREATE INDEX IF NOT EXISTS idx_locations_country_en ON locations(country_en);
CREATE INDEX IF NOT EXISTS idx_locations_country_ar ON locations(country_ar);
