-- =====================================================
-- Migration: Dashboard Layouts and Widget Configuration
...
CREATE UNIQUE INDEX idx_dashboard_layouts_unique_default 
  ON dashboard_layouts(user_id) 
  WHERE is_default = true;

-- Partial indexes for faster queries
CREATE INDEX idx_dashboard_layouts_is_default 
  ON dashboard_layouts(user_id, is_default) 
  WHERE is_default = true;

CREATE INDEX idx_dashboard_layouts_is_shared 
...
-- Add indexes
CREATE INDEX idx_widget_configurations_layout_id ON widget_configurations(layout_id);
CREATE INDEX idx_widget_configurations_widget_type ON widget_configurations(widget_type);
...
-- Add indexes
CREATE INDEX idx_shared_layout_access_layout_id ON shared_layout_access(layout_id);
CREATE INDEX idx_shared_layout_access_user_id ON shared_layout_access(shared_with_user_id);
CREATE INDEX idx_shared_layout_access_role ON shared_layout_access(shared_with_role);
