// Fixed import script for promoters matching actual database schema
...
async function importPromotersFixed() {
  console.log('=== Fixed Import: Promoters with Correct Schema ===');
  ...
  try {
    ...
    // Check for CSV file - try multiple possible names
