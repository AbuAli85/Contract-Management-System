describe('Promoter Management', () => {
  ...
  describe('Promoter List and Detail Views', () => {
    ...
    it('should handle lazy loading of CV data', () => {
      ...
      cy.get('[data-testid="cv-skills"]', { timeout: 10000 }).should(
        'be.visible'
      );
  ...
  describe('CSV Import/Export', () => {
    ...
    it('should handle duplicate emails during import', () => {
      ...
      cy.get('[data-testid="import-summary"]').should(
        'contain',
        'duplicates found'
      );
    });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle empty results', () => {
      ...
      cy.get('[data-testid="no-promoters-message"]').should(
        'contain',
        'No promoters found'
      );
    });
